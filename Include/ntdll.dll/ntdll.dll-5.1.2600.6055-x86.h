...
typedef struct _DPH_HEAP_ROOT {
    ...
    struct _DPH_HEAP_BLOCK *pBusyAllocationListHead;
    struct _DPH_HEAP_BLOCK *pBusyAllocationListTail;
    ...
    struct _DPH_HEAP_BLOCK *pAvailableAllocationListHead;
    struct _DPH_HEAP_BLOCK *pAvailableAllocationListTail;
    ...
    struct _DPH_HEAP_ROOT *pNextHeapRoot;
    struct _DPH_HEAP_ROOT *pPrevHeapRoot;
    ULONG nUnProtectionReferenceCount;
    ULONG InsideAllocateNode;
    ULONG ExtraFlags;
    ULONG Seed;
    PVOID NormalHeap;
...
typedef struct _STACK_TRACE_DATABASE {
    ...
    PLONG AcquireLockRoutine;
    PLONG ReleaseLockRoutine;
    PUCHAR OkayToLockRoutine;
    UCHAR PreCommitted;
...
RtlpCurrentDirectoryDeviceFlags;
...
RtlpUpdateTagEntry();
RtlpUpdateTimer();
RtlpUserIsRegistryAccessUntrusted();
