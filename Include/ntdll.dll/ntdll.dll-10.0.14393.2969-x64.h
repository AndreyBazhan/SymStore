...
typedef struct _MMSUPPORT_SHARED {
    ...
    PVOID ShadowMapping;
    ULONG64 WorkingSetSizeOverhead;
};
...
typedef struct _PROCESS_ENERGY_VALUES {
    ...
    USHORT Foreground : 1;
    USHORT DesktopVisible : 1;
    USHORT WindowInformation;
    USHORT CompositorRendered;
    USHORT DirtyGenerated;
    USHORT DirtyPropagated;
    LONG64 DesktopVisibilityReportTimestamp;
    ULONG64 DesktopVisibleTime;
    LONG64 ForegroundReportTimestamp;
    ULONG64 ForegroundTime;
};
...
_xmm;
`AppModelPolicy_GetPolicy'::`2'::AppModelPolicy_PolicyValue_Table;
