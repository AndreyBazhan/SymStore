...
typedef struct _DYNAMIC_FUNCTION_TABLE {
    ...
    ULONG64 BaseAddress;
    struct _IMAGE_ARM64_RUNTIME_FUNCTION_ENTRY **Callback;
    PVOID Context;
...
typedef struct _KPRCB {
    ...
    ULONG EmulatedFaultSyndrome;
    ULONG64 EmulatedFaultAddress;
    ULONG64 EmulatedLoadStoreAcquireRelease;
    ...
    struct _CACHE_DESCRIPTOR Cache[6];
    UCHAR CacheCount;
    UCHAR PrcbPad20[3];
    ULONG CachedCommit;
