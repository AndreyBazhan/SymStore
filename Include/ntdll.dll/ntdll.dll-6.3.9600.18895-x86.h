...
typedef struct _KPRCB {
    ...
    UCHAR BpbState;
    UCHAR BpbIbrsPresent : 1;
    UCHAR BpbStibpPresent : 1;
    UCHAR BpbSmepPresent : 1;
    UCHAR BpbSimulateIbrs : 1;
    UCHAR BpbSimulateIbpb : 1;
    UCHAR BpbCpuIdle : 1;
    UCHAR BpbReserved : 2;
    UCHAR PrcbPad50[31];
