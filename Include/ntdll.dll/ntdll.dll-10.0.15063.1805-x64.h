...
typedef struct _PROC_PERF_CONSTRAINT {
    ...
    UCHAR VirtualLittle;
    UCHAR ResolvedVirtualLittle;
    ULONG64 LastVirtualTranstionTsc;
    ULONG64 VirtualTranstionHysteresis;
    ULONG ProcCap;
    ULONG ProcFloor;
    ULONG TargetPercent;
...
typedef struct _PROC_PERF_DOMAIN {
    ...
    UCHAR AllowVirtualHeterogeneity;
    ...
    ULONG BackgroundSelectionGeneration;
    struct _PERF_CONTROL_STATE_SELECTION Selection;
...
_guard_ss_verify_failure_r10();
_guard_ss_verify_failure_r8();
_guard_ss_verify_failure_r9();
_guard_ss_verify_failure_rcx();
_guard_ss_verify_failure_rdx();
_guard_ss_verify_sp();
