...
typedef struct _KNODE {
    ...
    ULONG64 PpmConfiguredQosSets[5];
    ULONG64 Spare11;
    union _KQOS_GROUPING_SETS QosGroupingSets;
    ULONG64 QosPreemptibleSet;
    ULONG64 LLCLeaders;
};
...
typedef struct _KTHREAD {
    ...
    UCHAR PriorityFloorCountsReserved[16];
...
typedef struct _PROC_PERF_DOMAIN {
    ...
    ULONG QosDisableReasons[5];
    USHORT QosEquivalencyMasks[5];
    UCHAR QosSupported;
...
Feature_Servicing_EHCONT_Checks_28208890__private_descriptor;
Feature_Servicing_EHCONT_Checks_28208890__private_featureState;
Feature_Servicing_EHCONT_Checks_28208890__private_reporting;
Feature_Servicing_EHCONT_Checks_28208890_logged_traits;
GuidFormat;
HeapSnapshotEnd;
HeapSnapshotSnap;
HotPatchSpareGlobal1;
HotPatchSpareGlobal10;
HotPatchSpareGlobal11;
HotPatchSpareGlobal12;
HotPatchSpareGlobal13;
HotPatchSpareGlobal14;
HotPatchSpareGlobal15;
HotPatchSpareGlobal16;
HotPatchSpareGlobal2;
HotPatchSpareGlobal3;
HotPatchSpareGlobal4;
HotPatchSpareGlobal5;
HotPatchSpareGlobal6;
HotPatchSpareGlobal7;
HotPatchSpareGlobal8;
HotPatchSpareGlobal9;
...
_WIL_WNF_WIL_MACHINE_FEATURE_STORE;
_WIL_WNF_WIL_MACHINE_FEATURE_STORE_MODIFIED;
__PchSym_;
_clocalestr;
...
RTL_BINARY_ARRAY<RTLP_FLS_SLOT,8,4>::SetValue();
RXactpCommit();
RXactpOpenTargetKey();
RaiseException();
RcConsolidateFrames();
...
RtlCreateUmsCompletionList$fin$0();
RtlCreateUmsThreadContext();
RtlCreateUmsThreadContext$fin$0();
...
RtlDeleteUmsCompletionList$fin$0();
RtlDeleteUmsThreadContext();
RtlDeleteUmsThreadContext$fin$0();
...
RtlEnterUmsSchedulingMode$filt$0();
RtlEnumProcessHeaps();
...
RtlpReAllocateHeap$filt$4();
RtlpReAllocateHeap$fin$5();
