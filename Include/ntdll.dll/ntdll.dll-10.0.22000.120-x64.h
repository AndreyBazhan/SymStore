...
typedef struct _DYNAMIC_FUNCTION_TABLE {
    ...
    ULONG EntryCount;
    struct _RTL_BALANCED_NODE TreeNodeMin;
    struct _RTL_BALANCED_NODE TreeNodeMax;
};
...
typedef struct _ESERVERSILO_GLOBALS {
    ...
    struct _RTL_NLS_STATE RtlNlsState;
    struct _EX_TIMEZONE_STATE *ExTimeZoneState;
...
typedef struct _ETHREAD {
    ...
    UCHAR AllowUserWritesToExecutableMemory : 1;
    UCHAR AllowKernelWritesToExecutableMemory : 1;
    UCHAR OwnsVadShared : 1;
    UCHAR SessionAttachActive : 1;
    UCHAR PasidMsrValid : 1;
...
typedef struct _EX_TIMEZONE_STATE {
    struct _RTL_DYNAMIC_TIME_ZONE_INFORMATION TimeZoneInformation;
    ULONG CurrentTimeZoneId;
    LONG LastTimeZoneBias;
    union _LARGE_INTEGER TimeZoneBias;
    struct _TIMEZONE_CHANGE_EVENT TimeZone;
    struct _TIMEZONE_CHANGE_EVENT Century;
    struct _TIMEZONE_CHANGE_EVENT NextYear;
    LONG OkToTimeZoneRefresh;
    union _LARGE_INTEGER NextCenturyTimeInUTC;
    struct _TIME_FIELDS NextCenturyTimeFieldsInLocalTime;
    union _LARGE_INTEGER NextYearTimeInUTC;
    struct _TIME_FIELDS NextYearTimeFieldsInLocalTime;
    SHORT LastDynamicTimeZoneYear;
    union _LARGE_INTEGER NextSystemCutoverInUTC;
    ULONG RefreshFailures;
};
...
typedef struct _HEAP_DESCRIPTOR_KEY {
    ULONG Key;
    ULONG EncodedCommittedPageCount : 16;
    ULONG LargePageCost : 8;
    ULONG UnitCount : 8;
};
...
typedef struct _HEAP_LARGE_ALLOC_DATA {
    ...
    ULONG64 UnusedBytes : 16;
    ULONG64 ExtraPresent : 1;
    ULONG64 GuardPageCount : 1;
    ULONG64 GuardPageAlignment : 6;
    ULONG64 Spare : 4;
    ULONG64 AllocatedPages : 52;
};
...
typedef struct _HEAP_LFH_BUCKET {
    struct _HEAP_LFH_SUBSEGMENT_OWNER State;
    ULONG64 TotalBlockCount;
    ULONG64 TotalSubsegmentCount;
    ULONG ReciprocalBlockSize;
    UCHAR Shift;
    UCHAR ContentionCount;
    ULONG64 AffinityMappingLock;
    PUCHAR ProcAffinityMapping;
...
typedef struct _HEAP_LFH_SUBSEGMENT_OWNER {
    ...
    UCHAR SlotIndex;
    UCHAR Spare1;
    ULONG64 AvailableSubsegmentCount;
    ULONG64 Lock;
...
typedef struct _HEAP_LFH_UNUSED_BYTES_INFO {
    USHORT UnusedBytes : 14;
    USHORT ExtraPresent : 1;
    USHORT OneByteUnused : 1;
    UCHAR Bytes[2];
};
...
typedef struct _HEAP_OPPORTUNISTIC_LARGE_PAGE_STATS {
    ULONG64 SmallPagesInUseWithinLarge;
    ULONG64 OpportunisticLargePageCount;
};
...
typedef struct _HEAP_RUNTIME_MEMORY_STATS {
    ULONG64 TotalReservedPages;
    ULONG64 TotalCommittedPages;
    ULONG64 FreeCommittedPages;
    ULONG64 LfhFreeCommittedPages;
...
typedef struct _HEAP_SEG_CONTEXT {
    ...
    union {
        UCHAR LargePagePolicy : 3;
        UCHAR FullDecommit : 1;
        UCHAR ReleaseEmptySegments : 1;
        UCHAR LargeHeapFirstSegment : 1;
        UCHAR AllFlags;
    } Flags;
...
typedef struct _HEAP_VS_CONTEXT {
    ...
    ULONG64 TotalCommittedUnits;
    ULONG64 FreeCommittedUnits;
...
typedef struct _HEAP_VS_UNUSED_BYTES_INFO {
    USHORT UnusedBytes : 13;
    USHORT LfhSubsegment : 1;
    USHORT ExtraPresent : 1;
    USHORT OneByteUnused : 1;
    UCHAR Bytes[2];
};
...
typedef struct _KCLOCK_INCREMENT_TRACE {
    ULONG ActualIncrement;
    ULONG RequestedIncrement;
...
typedef struct _KCLOCK_TICK_TRACE {
    ULONG64 PerformanceCounter;
    ULONG64 PreInterruptTime;
    ULONG64 PostInterruptTime;
    ULONG64 TimeStampCounter;
    UCHAR IsClockOwner;
};
...
typedef struct _KCLOCK_TIMER_STATE {
    ULONG64 NextTickDueTime;
    ULONG TimeIncrement;
    ULONG LastRequestedTimeIncrement;
    enum _KCLOCK_TIMER_ONE_SHOT_STATE OneShotState;
    enum _KCLOCK_TIMER_DEADLINE_TYPE ExpectedWakeReason;
    struct _KCLOCK_TIMER_DEADLINE_ENTRY ClockTimerEntries[7];
    UCHAR ClockActive;
    ULONG ClockTickTraceIndex;
    ULONG ClockIncrementTraceIndex;
    struct _KCLOCK_TICK_TRACE ClockTickTraces[16];
    struct _KCLOCK_INCREMENT_TRACE ClockIncrementTraces[16];
};

typedef struct _KCORE_CONTROL_BLOCK {
    UCHAR ProcessorCount;
    UCHAR Spare[7];
    struct _KPRCB *Prcbs[8];
};
...
typedef struct _KERNEL_STACK_SEGMENT {
    ...
    ULONG64 KernelShadowStackBase;
    union _KERNEL_SHADOW_STACK_LIMIT KernelShadowStackLimit;
    ULONG64 KernelShadowStack;
    ULONG64 KernelShadowStackInitial;
};
...
typedef struct _KHETERO_HWFEEDBACK_CLASS {
    UCHAR PerformanceClass;
    UCHAR EfficiencyClass;
    UCHAR PerformanceClassRawValue;
    UCHAR EfficiencyClassRawValue;
};
...
typedef struct _KHETRO_HWFEEDBACK_TYPE {
    ULONG Count;
    struct _KHETERO_HWFEEDBACK_CLASS HwFeedbackClass[1];
};
...
typedef struct _KNODE {
    ...
    UCHAR PrimaryGroup;
    ULONG ActiveGroups;
    struct _KSCHEDULER_SUBNODE *SchedulerSubNodes[32];
};
...
typedef struct _KPRCB {
    ...
    ULONG64 RspBase;
    ULONG64 PrcbLock;
    union _KPRIORITY_STATE *PriorityState;
    CHAR CpuType;
    CHAR CpuID;
    USHORT CpuStep;
    UCHAR CpuStepping;
    ...
    ULONG64 PrcbPad04[5];
    struct _KSCHEDULER_SUBNODE *SchedulerSubNode;
    ...
    struct _KSTATIC_AFFINITY_BLOCK StaticAffinity;
    ...
    struct _KSINGLE_DPC_SOFT_TIMEOUT_EVENT_INFO *SingleDpcSoftTimeoutEventInfo;
    ...
    LONG DpcWatchdogPeriodTicks;
    LONG DpcWatchdogCount;
    LONG KeSpinLockOrdering;
    ULONG DpcWatchdogProfileCumulativeDpcThresholdTicks;
    PVOID CachedPtes;
    struct _LIST_ENTRY WaitListHead;
    ULONG64 WaitLock;
    ULONG ReadySummary;
    ...
    ULONG64 StartCycles;
    ULONG64 TaggedCycles[4];
    ULONG64 AffinitizedCycles;
    PULONG64 CyclesByThreadType;
    ULONG CpuCycleScalingFactor;
    USHORT PerformanceScoreByClass[8];
    USHORT EfficiencyScoreByClass[8];
    ULONG PrcbPad83[25];
    ULONG DpcWatchdogProfileSingleDpcThresholdTicks;
    LONG PrcbPad82;
    PVOID CachedStack;
    ULONG PageColor;
    ULONG NodeColor;
    ...
    struct _KCORE_CONTROL_BLOCK *CoreControlBlock;
    ULONG64 CoreProcessorSet;
    ULONG64 ScanSiblingMask;
    ULONG64 LLCMask;
    ULONG64 GroupModuleProcessorSet;
    ULONG64 PrcbPad97[3];
    ...
    struct _KCLOCK_TIMER_STATE ClockTimerState;
    UCHAR PrcbPad129[40];
    struct _REQUEST_MAILBOX *Mailbox;
    ULONG64 PrcbPad130[7];
    struct _MACHINE_CHECK_CONTEXT McheckContext[2];
    ULONG64 TransitionShadowStack;
    ULONG64 KernelShadowStackInitial;
    PULONG64 IstShadowStacksTable;
    PVOID CachedShadowStack;
    struct _KLOCK_QUEUE_HANDLE SelfmapLockHandle[4];
    ULONG64 PrcbPad134a[4];
    struct _KAFFINITY_EX DieProcessorSet;
    UCHAR CoresPerPhysicalDie;
    UCHAR LogicalProcessorsPerModule;
    UCHAR PrcbPad136a[6];
    UCHAR PrcbPad137[64];
    struct _KAFFINITY_EX ModuleProcessorSet;
    struct _KCORE_CONTROL_BLOCK LocalCoreControlBlock;
    UCHAR PrcbPad138[1120];
    ...
    ULONG DbgMceFlags;
    ULONG PrcbPad139b;
    struct _KAFFINITY_EX CacheProcessorSet[5];
    ULONG64 PrcbPad140[340];
    ULONG64 PrcbPad140a[8];
    ULONG64 PrcbPad141[504];
...
typedef struct _KPROCESS {
    ...
    ULONG64 KernelWaitTime;
    ULONG64 UserWaitTime;
    ULONG64 LastRebalanceQpc;
    PVOID PerProcessorCycleTimes;
    ULONG64 ExtendedFeatureDisableMask;
    USHORT PrimaryGroup;
    USHORT Spare3[3];
    PVOID UserCetLogging;
    ULONG64 EndPadding[3];
};
...
typedef struct _KSCHEDULER_SUBNODE {
    ...
    ULONG64 IdleSmtSet;
    ULONG64 NonPairedSmtSet;
    ULONG64 IdleModuleSet;
    ULONG64 IdleCpuSet;
    ULONG64 DeepIdleSet;
    ULONG64 IdleConstrainedSet;
    ULONG64 NonParkedSet;
    ULONG64 SoftParkedSet;
    ...
    struct _KHETERO_PROCESSOR_SET *HeteroSets;
    ULONG64 PpmConfiguredQosSets[6];
    ULONG64 Pad;
...
typedef struct _KSHARED_READY_QUEUE {
    ...
    union _KPRIORITY_STATE RunningSummary[64];
    union _KHETERO_STATE HeteroRunningSummary[64];
    UCHAR Span;
    UCHAR LowProcIndex;
    UCHAR QueueIndex;
    UCHAR NormalPriorityQueueIndex;
    UCHAR ProcCount;
    UCHAR ScanOwner;
    UCHAR Spare[2];
    ULONG64 Affinity;
...
typedef struct _KSOFTWARE_INTERRUPT_BATCH {
    UCHAR Level;
    UCHAR TargetType;
    UCHAR ReservedBatchInProgress;
    UCHAR Spare;
    ULONG SingleTargetIndex;
...
typedef struct _KTHREAD {
    ...
    ULONG Reserved : 7;
    LONG MiscFlags;
    ULONG UserIdealProcessorFixed : 1;
    ...
    LONG QueuePriority;
    struct _KPROCESS *Process;
    struct _KAFFINITY_EX *UserAffinity;
    USHORT UserAffinityPrimaryGroup;
    CHAR PreviousMode;
    CHAR BasePriority;
    ...
    ULONG PpmPolicy : 3;
    ULONG ThreadFlags3Reserved2 : 21;
    ...
    PVOID KernelShadowStack;
    PVOID KernelShadowStackInitial;
    PVOID KernelShadowStackBase;
    union _KERNEL_SHADOW_STACK_LIMIT KernelShadowStackLimit;
    ULONG64 ExtendedFeatureDisableMask;
    ULONG64 HgsFeedbackStartTime;
    ULONG64 HgsFeedbackCycles;
    ULONG HgsInvalidFeedbackCount;
    ULONG HgsLowerPerfClassFeedbackCount;
    ULONG HgsHigherPerfClassFeedbackCount;
    ULONG Spare27;
    struct _SINGLE_LIST_ENTRY SystemAffinityTokenListHead;
    PVOID IptSaveArea;
    ULONG64 EndPadding[4];
};
...
typedef struct _KUSER_SHARED_DATA {
    ...
    struct _KSYSTEM_TIME FeatureConfigurationChangeStamp;
    ULONG Spare;
};
...
typedef struct _LDR_HOT_PATCH_DATA {
    ULONG Version;
    PLONG PatchLoadLibrary;
    PLONG PatchGetProcAddress;
};
...
typedef struct _OBP_SILODRIVERSTATE {
    struct _EX_FAST_REF SystemDeviceMap;
...
typedef struct _PEBS_DS_SAVE_AREA32 {
    ...
    ULONG64 PebsGpCounterReset[8];
    ULONG64 PebsFixedCounterReset[4];
};
...
typedef struct _PROCESSOR_CYCLES_WORKLOAD_CLASS {
    ULONG Count;
    ULONG64 ProcessorCyclesClass[1];
};
...
typedef struct _PROCESSOR_POWER_STATE {
    ...
    UCHAR EarlyBootArchitecturalEfficiencyClass;
    UCHAR Parked;
    ...
    USHORT HwFeedbackTableOffset;
    UCHAR HwFeedbackParkHint;
    UCHAR HeteroCoreType;
    USHORT HwFeedbackTableIndex;
    struct _KHETRO_HWFEEDBACK_TYPE *HwFeedbackClassList;
    struct _PROCESSOR_CYCLES_WORKLOAD_CLASS *EeCyclesWorkloadClassList;
    struct _PROCESSOR_CYCLES_WORKLOAD_CLASS *PerfCyclesWorkloadClassList;
    UCHAR NotUsed;
};
...
typedef struct _PROC_PERF_CHECK {
    ...
    struct _PROC_PERF_CHECK_CYCLE_SNAP *LastPerfCheckCycleSnap;
    struct _PROC_PERF_CHECK_SNAP CurrentSnap;
    struct _PROC_PERF_CHECK_CYCLE_SNAP *CurrentCycleSnap;
    struct _PROC_PERF_CHECK_SNAP LastDeliveredSnap;
    struct _PROC_PERF_CHECK_CYCLE_SNAP *LastDeliveredCycleSnap;
    ULONG LastDeliveredPerformance;
    ULONG LastDeliveredFrequency;
    UCHAR TaggedThreadPercent[4];
    UCHAR ImportantPercent;
    UCHAR Class0FloorPerfSelection;
    UCHAR Class1MinimumPerfSelection;
    ULONG CurrentResponsivenessEvents;
    ULONG64 CyclesByFreqBand[3][48];
};
...
typedef struct _PROC_PERF_CHECK_CYCLE_SNAP {
    ...
    ULONG64 TaggedThreadCycles[4];
    ULONG WorkloadClasses;
    ULONG64 ThreadTypeCycles[1];
};
...
typedef struct _PROC_PERF_DOMAIN {
    ...
    PVOID PerfControlHandlerHidden;
    PVOID DomainPerfControlHandler;
    PVOID PerfUpdateHwDebugData;
    PULONG PerfQueryProcMeasurementCapabilities;
    PLONG PerfQueryProcMeasurementValues;
    ULONG Id;
    ULONG MaxFrequency;
    ...
    UCHAR AllowVmPerfSelection;
    ULONG VmFrequencyStepMhz;
    ULONG VmHighestFrequencyMhz;
    ULONG VmNominalFrequencyMhz;
    ULONG VmLowestFrequencyMhz;
    UCHAR AutonomousMode;
    UCHAR ProvideGuidance;
    ULONG DesiredPercent;
    ULONG GuaranteedPercent;
    UCHAR EngageResponsivenessOverrides;
    struct _PROC_PERF_QOS_CLASS_POLICY QosPolicies[6];
    ULONG QosDisableReasons[6];
    USHORT QosEquivalencyMasks[6];
    UCHAR QosSupported;
    ULONG SelectionGeneration;
    struct _PERF_CONTROL_STATE_SELECTION QosSelection[6];
...
typedef struct _PROC_PERF_HISTORY {
    ...
    ULONG ImportantPercentTotal;
    ULONG TaggedPercentTotal[4];
...
typedef struct _PS_NTDLL_EXPORTS {
    PVOID LdrSystemDllInitBlock;
    PVOID LdrInitializeThunk;
    PVOID RtlUserThreadStart;
    PVOID RtlUserFiberStart;
    PVOID KiUserExceptionDispatcher;
    PVOID KiUserApcDispatcher;
    PVOID KiUserCallbackDispatcher;
    PVOID KiUserCallbackDispatcherReturn;
    PVOID KiRaiseUserExceptionDispatcher;
    PVOID ExpInterlockedPopEntrySListEnd;
    PVOID ExpInterlockedPopEntrySListFault;
    PVOID ExpInterlockedPopEntrySListResume;
    PVOID RtlpFreezeTimeBias;
    PVOID KiUserInvertedFunctionTable;
    PVOID WerReportExceptionWorker;
    PVOID RtlCallEnclaveReturn;
    PVOID RtlEnclaveCallDispatch;
    PVOID RtlEnclaveCallDispatchReturn;
    PVOID RtlRaiseExceptionForReturnAddressHijack;
    PVOID KiUserEmulationDispatcher;
    PVOID LdrHotPatchNotify;
};
...
typedef struct _REQUEST_MAILBOX {
    ...
    PLONG SubNodeTargetCountAddr;
    LONG SubNodeTargetCount;
};

typedef struct _RTLP_HP_ALLOC_TRACKER {
    ULONG64 BaseAddress;
    struct _RTL_CSPARSE_BITMAP AllocTrackerBitmap;
    UCHAR AllocTrackerBitmapBuffer[72];
};
...
typedef struct _RTLP_HP_HEAP_MANAGER {
    ...
    struct _RTLP_HP_METADATA_HEAP_CTX MetadataHeaps[4];
...
typedef struct _RTL_CSPARSE_BITMAP {
    ...
    ULONG CommitDirectoryMaxSize;
    ULONG64 CommitDirectory[1];
};
...
typedef struct _RTL_HP_LFH_CONFIG {
    ...
    USHORT DisableRandomization : 1;
};

typedef struct _RTL_HP_SEG_ALLOC_POLICY {
    ULONG64 MinLargePages;
    ULONG64 MaxLargePages;
...
typedef struct _RTL_NLS_STATE {
    struct _CPTABLEINFO DefaultAcpTableInfo;
    struct _CPTABLEINFO DefaultOemTableInfo;
    PWCHAR ActiveCodePageData;
    PWCHAR OemCodePageData;
    PWCHAR LeadByteInfo;
    PWCHAR OemLeadByteInfo;
    PWCHAR CaseMappingData;
    PWCHAR UnicodeUpcaseTable844;
    PWCHAR UnicodeLowercaseTable844;
};
...
typedef struct _SEGMENT_HEAP {
    ...
    PVOID UserContext;
    ULONG64 ReservedMustBeZero2;
    PVOID Spare;
    ULONG64 LargeMetadataLock;
    struct _RTL_RB_TREE LargeAllocMetadata;
    ULONG64 LargeReservedPages;
    ULONG64 LargeCommittedPages;
    ULONG64 Tag;
    union _RTL_RUN_ONCE StackTraceInitVar;
    struct _HEAP_RUNTIME_MEMORY_STATS MemStats;
    USHORT GlobalLockCount;
    ULONG GlobalLockOwner;
    ULONG64 ContextExtendLock;
    PUCHAR AllocatedBase;
    PUCHAR UncommittedBase;
    PUCHAR ReservedLimit;
    PUCHAR ReservedRegionEnd;
...
typedef struct _SILO_USER_SHARED_DATA {
    ...
    UCHAR IsStateSeparationEnabled;
    WCHAR NtSystemRoot[260];
    USHORT UserModeGlobalLogger[16];
    ULONG TimeZoneId;
    LONG TimeZoneBiasStamp;
...
typedef struct _TEB {
    ...
    struct _CHPEV2_CPUAREA_INFO *ChpeV2CpuAreaInfo;
    PVOID Unused;
    ULONG MuiGeneration;
...
typedef struct _flags {
    UCHAR SmtSetsPresent : 1;
    UCHAR Fill : 7;
};

typedef union RTLP_HP_LFH_PERF_FLAGS {
    ULONG HotspotDetection : 1;
    ULONG HotspotFullCommit : 1;
    ULONG ActiveSubsegment : 1;
    ULONG SmallerSubsegment : 1;
    ULONG SingleAffinitySlot : 1;
    ULONG ApplyLfhDecommitPolicy : 1;
    ULONG EnableGarbageCollection : 1;
    ULONG LargePagePreCommit : 1;
    ULONG OpportunisticLargePreCommit : 1;
    ULONG LfhForcedAffinity : 1;
    ULONG LfhCachelinePadding : 1;
    ULONG AllFlags;
};
...
typedef union _HEAP_SEGMENT_MGR_COMMIT_STATE {
    USHORT CommittedPageCount : 11;
    USHORT Spare : 3;
    USHORT LargePageOperationInProgress : 1;
    USHORT LargePageCommit : 1;
    USHORT EntireUShortV;
    USHORT EntireUShort;
};
...
typedef union _KERNEL_SHADOW_STACK_LIMIT {
    ULONG64 AllFields;
    ULONG64 ShadowStackType : 3;
    ULONG64 Unused : 9;
    ULONG64 ShadowStackLimitPfn : 52;
};
...
typedef union _KPRIORITY_STATE {
    UCHAR Priority : 7;
    UCHAR IsolationWidth : 1;
    UCHAR AllFields;
};

typedef union _KQOS_GROUPING_SETS {
    ULONG64 SingleCoreSet;
    ULONG64 SmtSet;
};
...
_guard_eh_cont_table;
_guard_fids_table;
_guard_xfg_check_icall_fptr;
_guard_xfg_dispatch_icall_fptr;
_guard_xfg_table_dispatch_icall_fptr;
_imp_NtClose;
_imp_NtCreateFile;
_imp_NtDeviceIoControlFile;
...
_newcumap;
_real;
_realbfc5555555555555;
_realbfe5c28f5c28f5c3;
_realbff0000000000000;
_realc000000000000000;
_realc010000000000000;
_security_cookie;
_security_cookie_complement;
_xmm;
_xmmabababababababababababababababab;
`AppModelPolicy_GetPolicy_Internal'::`2'::AppModelPolicy_PolicyValue_Table;
`RtlpGetCookieValue'::`2'::CookieValue;
...
`SignalStartWerSvc'::`2'::WerSvcTriggerGuid;
...
AppendCumulativeOverlayFilePath();
AppendStandardOverlayFilePath();
AvrfMiniLoadDll();
BuildCumulativeOverlayFilePath();
BuildStandardOverlayFilePath();
...
EtwEnumerateProcessRegGuids$fin$0();
...
EtwpCheckForEnoughStackSpace$filt$0();
...
EtwpTraceUmEvent();
EtwpTraceUmEvent$fin$0();
EtwpTraceUmEvent$fin$1();
EtwpTraceUmMessage();
EtwpTraceUmMessage$fin$0();
EtwpTraceUmMessage$fin$1();
...
GetOverlayPackagePathFromKey();
GetOverlayPackageTypeFromKey();
GetProcessIptTrace();
...
InsertChar();
InsertModuleFunctions<_IMAGE_THUNK_DATA32,unsigned long,2147483648>();
InsertModuleFunctions<_IMAGE_THUNK_DATA64,unsigned __int64,-9223372036854775808>();
...
LdrAccessResource();
LdrAddDllDirectory();
LdrAddDllDirectory$fin$0();
LdrAddLoadAsDataTable();
LdrAddLoadAsDataTable$fin$0();
LdrAddRefDll();
...
LdrEnumerateLoadedModules$fin$0();
...
LdrFlushAlternateResourceModules$fin$0();
LdrForkMrdata();
LdrGetDllDirectory();
LdrGetDllFullName();
LdrGetDllHandle();
LdrGetDllHandleByMapping();
LdrGetDllHandleByMapping$filt$0();
LdrGetDllHandleByName();
LdrGetDllHandleByName$filt$0();
LdrGetDllHandleEx();
LdrGetDllPath();
LdrGetFailureData();
...
LdrLoadAlternateResourceModuleEx$fin$0();
LdrLoadDll();
LdrLoadEnclaveModule();
LdrLockLoaderLock();
LdrLockLoaderLock$filt$0();
...
LdrQueryProcessModuleInformationEx$fin$0();
LdrQueryProcessModuleInformationEx2();
LdrQueryProcessModuleInformationEx2$fin$0();
LdrRegisterDllNotification();
LdrRelocateImageWithBias();
LdrRemoveDllDirectory();
LdrRemoveLoadAsDataTable();
LdrRemoveLoadAsDataTable$fin$0();
...
LdrResolveDelayLoadedAPI$fin$0();
...
LdrSetMUICacheType();
LdrShutdownProcess();
LdrShutdownProcess$fin$0();
LdrShutdownProcess$fin$1();
LdrShutdownThread();
LdrShutdownThread$fin$0();
LdrShutdownThread$fin$1();
LdrShutdownThread$fin$2();
...
LdrUnloadDll();
LdrUnlockLoaderLock();
LdrUnlockLoaderLock$filt$0();
LdrUnregisterDllNotification();
LdrUpdatePackageSearchPath();
LdrVerifyImageMatchesChecksum();
LdrVerifyImageMatchesChecksumEx();
LdrVerifyImageMatchesChecksumEx$filt$0();
LdrVerifyImageMatchesChecksumEx$filt$1();
LdrVerifyImageMatchesChecksumEx$fin$2();
LdrVerifyImageMatchesChecksumEx$fin$3();
...
LdrpAllocateTls();
LdrpAllocateTls$filt$0();
LdrpAllocateTlsEntry();
LdrpAllocateTlsEntry$filt$0();
...
LdrpCalcAllocSize();
LdrpCallInitRoutine();
LdrpCallInitRoutine$fin$0();
LdrpCallTlsInitializers();
LdrpCallTlsInitializers$filt$0();
...
LdrpGetFileSizeFromLoadAsDataTable$fin$0();
...
LdrpHandleProtectedDelayload$fin$0();
LdrpHandleReplacedModule();
LdrpHandleTlsData();
LdrpHandleTlsData$filt$0();
...
LdrpInitializeThread$fin$0();
LdrpInitializeThread$fin$1();
LdrpInitializeThread$fin$2();
LdrpInitializeTls();
...
LdrpLoadDependentModuleInternal$fin$0();
LdrpLoadDependentModuleW();
LdrpLoadDll();
LdrpLoadDllInternal();
LdrpLoadDllInternal$fin$0();
LdrpLoadEnclaveModule();
LdrpLoadForwardedDll();
LdrpLoadForwardedDll$fin$0();
LdrpLoadKnownDll();
LdrpLoadPatchImage();
...
PssNtValidateDescriptor$filt$0();
PssNtWalkSnapshot();
...
PsspCaptureVaSpaceInformation2();
PsspDumpObject_Event();
PsspDumpObject_Mutant();
PsspDumpObject_Process();
PsspDumpObject_Section();
PsspDumpObject_Semaphore();
PsspDumpObject_Thread();
PsspDumpThread();
PsspDuplicateSnapshotLocalToRemote();
PsspDuplicateSnapshotRemoteToRemote();
PsspFreeLinkedHandleList();
PsspHandleDumper();
PsspHandleStreamSizeCalculator();
...
QueryRegistryValue();
RTL_BINARY_ARRAY<RTLP_FLS_CALLBACK_ENTRY,8,4>::SlotAllocate();
RTL_BINARY_ARRAY<RTLP_FLS_CALLBACK_ENTRY,8,4>::SlotFree();
RTL_BINARY_ARRAY<RTLP_FLS_SLOT,8,4>::ChunkAllocate();
RXactpCommit();
RXactpOpenTargetKey();
RaiseException();
RcConsolidateFrames();
...
RtlCheckHeldCriticalSections$fin$0();
...
RtlCompactHeap();
RtlCompactHeap$filt$0();
RtlCompactHeap$fin$1();
RtlCompareAltitudes();
...
RtlCreateTagHeap();
RtlCreateTagHeap$fin$0();
RtlCreateTimer();
RtlCreateTimer$fin$0();
RtlCreateTimer$fin$1();
RtlCreateTimerQueue();
RtlCreateTimerQueue$fin$0();
...
RtlCreateUserStack();
RtlCreateUserStack$filt$0();
RtlCreateUserStack$filt$1();
RtlCreateUserThread();
...
RtlDebugAllocateHeap$filt$0();
RtlDebugAllocateHeap$fin$1();
RtlDebugCompactHeap();
RtlDebugCompactHeap$filt$0();
RtlDebugCompactHeap$fin$1();
RtlDebugCreateHeap();
RtlDebugCreateTagHeap();
RtlDebugCreateTagHeap$filt$0();
RtlDebugCreateTagHeap$fin$1();
RtlDebugDestroyHeap();
RtlDebugFreeHeap();
RtlDebugFreeHeap$filt$0();
RtlDebugFreeHeap$fin$1();
RtlDebugGetUserInfoHeap();
RtlDebugGetUserInfoHeap$filt$0();
RtlDebugGetUserInfoHeap$fin$1();
RtlDebugPrintTimes();
RtlDebugQueryTagHeap();
RtlDebugQueryTagHeap$filt$0();
RtlDebugQueryTagHeap$fin$1();
RtlDebugReAllocateHeap();
RtlDebugReAllocateHeap$filt$0();
RtlDebugReAllocateHeap$fin$1();
RtlDebugSetUserFlagsHeap();
RtlDebugSetUserFlagsHeap$filt$0();
RtlDebugSetUserFlagsHeap$fin$1();
RtlDebugSetUserValueHeap();
RtlDebugSetUserValueHeap$filt$0();
RtlDebugSetUserValueHeap$fin$1();
RtlDebugSizeHeap();
RtlDebugSizeHeap$filt$0();
RtlDebugSizeHeap$fin$1();
RtlDebugWalkHeap();
RtlDebugWalkHeap$filt$0();
RtlDebugZeroHeap();
RtlDebugZeroHeap$filt$0();
RtlDebugZeroHeap$fin$1();
RtlDecodePointer();
...
RtlDeleteCriticalSection$fin$0();
...
RtlDeleteTimer();
RtlDeleteTimer$fin$0();
RtlDeleteTimer$fin$1();
RtlDeleteTimerQueue();
RtlDeleteTimerQueueEx();
RtlDeleteTimerQueueEx$fin$0();
RtlDeleteTimerQueueEx$fin$1();
...
RtlDeregisterWait();
RtlDeregisterWaitEx();
RtlDeregisterWaitEx$fin$0();
RtlDeregisterWaitEx$fin$1();
...
RtlGetFullPathName_Ustr$fin$0();
RtlGetFullPathName_UstrEx();
RtlGetFunctionTableListHead();
RtlGetGroupSecurityDescriptor();
RtlGetImageFileMachines();
RtlGetImageFileMachines$filt$0();
RtlGetImageFileMachines$fin$1();
RtlGetIntegerAtom();
...
RtlGetUserInfoHeap();
RtlGetUserInfoHeap$filt$0();
RtlGetUserInfoHeap$fin$1();
...
RtlQueryCriticalSectionOwner$fin$0();
RtlQueryDepthSList();
RtlQueryDynamicTimeZoneInformation();
RtlQueryElevationFlags();
RtlQueryEnvironmentVariable();
RtlQueryEnvironmentVariable$filt$1();
RtlQueryEnvironmentVariable$fin$0();
...
RtlQueryInformationActivationContext$fin$0();
...
RtlQueryProcessBackTraceInformation$fin$0();
RtlQueryProcessDebugInformation();
RtlQueryProcessHeapInformation();
RtlQueryProcessHeapInformation$fin$0();
RtlQueryProcessLockInformation();
RtlQueryProcessLockInformation$fin$0();
...
RtlQueryWnfStateData$filt$0();
RtlQueryWnfStateDataWithExplicitScope();
RtlQueryWnfStateDataWithExplicitScope$filt$0();
RtlQueueApcWow64Thread();
RtlQueueWorkItem();
RtlQueueWorkItem$fin$0();
...
RtlRegisterWait();
RtlRegisterWait$fin$0();
RtlRegisterWait$fin$1();
...
RtlReportExceptionEx$fin$0();
RtlReportExceptionHelper();
RtlReportExceptionHelper$fin$0();
RtlReportFatalFailure();
RtlReportFatalFailure$filt$0();
...
RtlSetEnvironmentStrings$fin$0();
RtlSetEnvironmentStrings$fin$1();
RtlSetEnvironmentVar();
RtlSetEnvironmentVar$fin$0();
...
RtlSetIoCompletionCallback$fin$0();
RtlSetIoCompletionCallback$fin$1();
...
RtlSetUserFlagsHeap();
RtlSetUserFlagsHeap$filt$0();
RtlSetUserFlagsHeap$fin$1();
RtlSetUserValueHeap();
RtlSetUserValueHeap$fin$0();
RtlSidDominates();
...
RtlUpdateTimer();
RtlUpdateTimer$fin$0();
RtlUpdateTimer$fin$1();
RtlUpperChar();
RtlUpperString();
RtlUserFiberStart();
RtlUserThreadStart();
RtlUserThreadStart$filt$0();
RtlValidAcl();
...
RtlValidateHeap();
RtlValidateHeap$filt$0();
RtlValidateHeap$fin$1();
...
RtlWow64PopAllCrossProcessWorkFromWorkList$filt$0();
RtlWow64PopCrossProcessWorkFromFreeList();
RtlWow64PopCrossProcessWorkFromFreeList$filt$0();
RtlWow64PushCrossProcessWorkOntoFreeList();
RtlWow64PushCrossProcessWorkOntoFreeList$filt$0();
RtlWow64PushCrossProcessWorkOntoWorkList();
RtlWow64PushCrossProcessWorkOntoWorkList$filt$0();
RtlWow64RequestCrossProcessHeavyFlush();
RtlWow64RequestCrossProcessHeavyFlush$filt$0();
...
RtlpHpReAllocWithExceptionProtection$filt$0();
...
RtlpHpSegGetDescriptorValidateSafe$filt$0();
...
RtlpMoveActCtxToFreeList$fin$0();
...
RtlpNotOwnerCriticalSection$filt$0();
RtlpNtCreateKey();
...
RtlpQueryPseudoEnvironmentVariable$fin$0();
RtlpQueryReadVirtualMemory();
...
RtlpReAllocateHeap();
RtlpReAllocateHeap$filt$0();
RtlpReAllocateHeap$filt$1();
RtlpReAllocateHeap$filt$2();
RtlpReAllocateHeap$filt$3();
RtlpReAllocateHeap$filt$5();
RtlpReAllocateHeap$fin$4();
...
RtlpSetProcUserMachineLangList$fin$0();
RtlpSetProcessDebugInformationRemote();
RtlpSetRequestedFrontEndHeap();
RtlpSetRequestedFrontEndHeap$fin$0();
...
RtlpWnfWalkUserSubscriptionList$fin$0();
...
ShipAssertMsgW();
SignalStartWerSvc();
StartPathWithLongPathPrefixIfNeeded();
StringCbPrintfA();
StringCbPrintfW();
StringCchCopyNW();
StringCchCopyW();
...
TpAllocCleanupGroup();
TpAllocCleanupGroup$fin$0();
TpAllocIoCompletion();
TpAllocIoCompletion$fin$0();
TpAllocIoCompletion$fin$1();
TpAllocJobNotification();
TpAllocPool();
TpAllocPoolInternal();
TpAllocPoolInternal$fin$0();
TpAllocPoolInternal$fin$1();
TpAllocPoolInternal$fin$2();
TpAllocTimer();
TpAllocWait();
TpAllocWork();
TpAllocWork$fin$0();
...
TpPoolReferenceExistingGlobalPool$fin$0();
TpPostTask();
TpPostWork();
...
TpReleaseCleanupGroupMembers$fin$0();
TpReleaseCleanupGroupMembers$fin$1();
TpReleaseCleanupGroupMembers$fin$2();
...
TpSetDefaultPoolStackInformation$fin$0();
TpSetPoolMaxThreads();
...
TpSetWaitEx();
TpSimpleTryPost();
TpSimpleTryPost$fin$0();
TpSimpleTryPost$fin$1();
TpSimpleTryPost$fin$2();
...
TppAllocAlpcCompletion$fin$0();
TppAllocAlpcCompletion$fin$1();
TppAllocThreadData();
...
TppCleanupGroupAddMember$fin$0();
TppCleanupGroupMemberCallbackProlog();
TppCleanupGroupMemberDestroy();
TppCleanupGroupMemberDestroy$fin$0();
TppCleanupGroupMemberDestroy$fin$1();
TppCleanupGroupMemberInitialize();
TppCleanupGroupMemberInitialize$fin$0();
TppCleanupGroupMemberInitialize$fin$1();
TppCleanupGroupMemberInitialize$fin$2();
TppCleanupGroupMemberInitialize$fin$3();
TppCleanupGroupMemberRelease();
TppCleanupGroupRemoveMember();
TppCleanupGroupRemoveMember$fin$0();
TppCompleteThreadData();
TppCritResetThread();
TppCritSetThread();
TppCritSetThread$fin$0();
TppCritSetThread$fin$1();
TppCritSetThread$fin$2();
TppCritSetThread$fin$3();
TppCritSetThread$fin$4();
TppDestroyTimer();
...
TppPHInsert();
TppPoolAddWorker();
TppPoolAddWorker$fin$0();
TppPoolRemoveWorker();
TppPoolRemoveWorker$fin$0();
TppPoolUpdateNodeRelation();
TppPoolUpdateTrimmedWorker();
TppPoolpDereferenceGlobalPool();
TppPoolpDereferenceGlobalPool$fin$0();
TppPoolpFree();
TppPoolpFree$fin$0();
TppPoolpReferenceGlobalPool();
TppPoolpReferenceGlobalPool$fin$0();
TppPoolpReferenceGlobalPool$fin$1();
TppPrepareDirectParams();
TppQueueRemoveHead();
TppRaiseHandleStatus();
TppRaiseInvalidParameter();
TppRaiseInvalidParameter$filt$0();
...
TppWorkerSwitchNode();
TppWorkerThread();
TppWorkerThread$filt$11();
TppWorkerThread$filt$2();
TppWorkerThread$filt$3();
TppWorkerThread$filt$4();
TppWorkerThread$filt$5();
TppWorkerThread$filt$6();
TppWorkerThread$fin$0();
TppWorkerThread$fin$1();
TppWorkerThread$fin$10();
TppWorkerThread$fin$7();
TppWorkerThread$fin$8();
TppWorkerThread$fin$9();
...
WerEscalationReadImageVersionInfoForModuleBaseSafe$filt$0();
...
_cpu_features_init();
_ctrlfp$filt$0();
_except_validate_context_record();
...
_toascii();
_whiteout();
`sxsisol_ExpandEnvironmentStrings_UEx'::`1'::fin$0();
abs();
adapt();
alloca_probe();
atan();
...
tlgDefineProvider_annotation__TlgCentennialIssueTracker_TraceLoggingProviderProv();
tlgDefineProvider_annotation__TlgLdrpMuiResourceLoaderTraceLoggingProviderProv();
tlgDefineProvider_annotation__TlgRtlpCapChkTraceLoggingProviderProv();
tlgDefineProvider_annotation__TlgRtlpHpTraceLoggingProviderProv();
tlgDefineProvider_annotation__TlgRtlpXfgAuditTraceLoggingProviderProv();
tlgDefineProvider_annotation__Tlgg_LibLoaderProviderProv();
tlgDefineProvider_annotation__Tlgg_VsmEnclaveTraceProviderProv();
tlgDefineProvider_annotation__Tlgmtaum_hTelemetryAssertDiagTrackProv();
tlgDefineProvider_annotation__Tlgmtaum_hTelemetryAssertProv();
tlgKeywordOn();
