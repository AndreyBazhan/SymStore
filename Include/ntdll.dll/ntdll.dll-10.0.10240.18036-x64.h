...
typedef struct _DYNAMIC_FUNCTION_TABLE {
    ...
    PVOID Context;
    PUSHORT OutOfProcessCallbackDll;
...
typedef struct _EJOB {
    ...
    struct _EJOB *EffectiveDiskIoRateLimitJob;
...
RtlpGetUserInfoHeapInternal$filt$0();
RtlpGetUserInfoHeapInternal$fin$1();
...
RtlpSetUserFlagsHeapInternal$filt$0();
RtlpSetUserFlagsHeapInternal$fin$1();
RtlpSetUserValueHeapInternal();
RtlpSetUserValueHeapInternal$fin$0();
...
RtlpValidateHeapInternal$filt$0();
RtlpValidateHeapInternal$fin$1();
