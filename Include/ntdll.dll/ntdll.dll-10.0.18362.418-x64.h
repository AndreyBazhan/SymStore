...
typedef struct _PROC_PERF_CONSTRAINT {
    struct _KPRCB *Prcb;
    ULONG64 PerfContext;
    UCHAR HiddenProcessor;
    ULONG HiddenProcessorId;
    ULONG PlatformCap;
    ULONG ThermalCap;
    ULONG LimitReasons;
...
AvrfpLoaderEntry;
CachedLanguageOverlayGroupPolicyState;
...
QueryRegistryValue();
RTLP_FLS_CALLBACK_ENTRY::IsEmpty();
...
RTL_BINARY_ARRAY<RTLP_FLS_SLOT,8,4>::Cleanup();
