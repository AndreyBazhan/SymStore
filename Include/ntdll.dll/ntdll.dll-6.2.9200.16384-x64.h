...
typedef struct _PPM_IDLE_STATES {
    ...
    ULONG TargetState;
    ULONG ActualState;
    ULONG ActualPlatformState;
    ULONG OldState;
    ULONG OverrideIndex;
    ULONG PlatformIdleCount;
    ULONG ProcessorIdleCount;
    ULONG Type;
    ULONG ReasonFlags;
    LONG64 InitiateWakeStamp;
    LONG PreviousStatus;
...
typedef struct _PROCESSOR_POWER_STATE {
    ...
    struct _PLATFORM_IDLE_ACCOUNTING *PlatformIdleAccounting;
...
RtlpAffinitizeSegmentInfoForBucket$fin$0();
...
RtlpWnfNotificationThread$filt$0();
