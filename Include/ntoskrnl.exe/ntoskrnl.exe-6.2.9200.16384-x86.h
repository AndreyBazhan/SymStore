...
MAX_CLIENT_PENDING_QUEUE_DEPTH;
...
PipDevnodeStatusFlags;
PipDevnodeStatusUserFlags;
PltRotBarStatus;
...
AhcLockCreate();
AhcLockDelete();
AhcLockReleaseExclusive();
AhcLockReleaseShared();
AhcLookup();
AhcMessageCreateExe();
AhcMessageDelete();
AhcOpenRegKey();
...
CmpTryConvertRegistryExclusive();
...
DrvDbDeleteDriverFile();
DrvDbDeleteDriverInfFile();
DrvDbDeleteDriverPackage();
...
ExpWnfCalculateProcessThreadGoal();
...
IovUtilIsFastIoDetachSupported();
IovUtilIsInFdoStack();
IovUtilIsPdo();
IovUtilIsRawPdo();
...
PiDqObjectActionQueueEntryFree();
PiDqObjectManagerEnterActionQueueProcessing();
PiDqObjectManagerEnumerateAndRegisterQuery();
PiDqObjectManagerHandleObjectEvent();
PiDqObjectManagerInit();
PiDqObjectManagerLeaveActionQueueProcessing();
PiDqObjectManagerLockData();
PiDqObjectManagerMakeInconsistent();
PiDqObjectManagerResumeActionQueueProcessing();
PiDqObjectManagerServiceActionQueue();
PiDqObjectManagerSuspendActionQueueProcessing();
...
PiDqTraceProcessingStart();
PiDqTraceProcessingStop();
PiDqTraceQueryClose();
...
PiPnpRtlRaisePropertyChangeEvent();
...
PlugPlayGetDeviceInterfaceEnabled();
...
PopNewWakeInfo();
PopNewWakeSource();
PopNonAoacExecutionRequiredPowerRequest();
...
PpmUpdateIdleStates();
PpmUpdateLowPowerScenarioAccounting();
...
PspIsDfssEnabled();
PspIsEnforcementAccountingNonZero();
PspIsProcessInJob();
PspJobClose();
...
SeCheckForAllAppPackagesAceRemoval();
...
_CmGetContainerIsRebootRequiredProperty();
