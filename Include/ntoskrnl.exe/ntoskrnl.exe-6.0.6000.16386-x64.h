...
typedef struct _CONTROL_AREA {
    ...
    ULONG StartingFrame;
    struct _MI_SECTION_CREATION_EVENT *WaitingForDeletion;
    union {
        struct {
...
typedef struct _MI_SECTION_CREATION_EVENT {
    struct _MI_SECTION_CREATION_EVENT *Next;
    struct _KEVENT Event;
};
...
typedef struct _SEGMENT_FLAGS {
    ULONG64 TotalNumberOfPtes4132 : 10;
    ULONG64 ExtraSharedWowSubsections : 1;
    ULONG64 LargePages : 1;
    ULONG64 WatchProto : 1;
    ULONG64 DebugSymbolsLoaded : 1;
    ULONG64 WriteCombined : 1;
    ULONG64 NoCache : 1;
    ULONG64 FloppyMedia : 1;
    ULONG64 DefaultProtectionMask : 5;
    ULONG64 ContainsPxeSubsection : 1;
    ULONG64 Spare : 40;
    ULONG64 Binary32 : 1;
};
...
CcDbgNumberOfFailedMappingsDueToKernelVa;
...
HvlpEnlightenLock;
HvlpHypercallCodeVa;
HvlpHypervisorConnected;
HvlpNotifyCallbackAtPhase2;
...
IopRegistryAllCallbackTypes;
IopRegistryCallbackCookie;
IopRegistryCallbacksLastIndex;
IopReserveIrps;
...
MmNonPagedPoolExpansionStartPte;
MmNonPagedPoolLock;
MmNonPagedPoolStart;
...
PopBackgroundTasksIgnoreIterations;
PopCB;
PopCapabilities;
...
PopNonIdleDiskIntervals;
PopNotifyEvents;
PopNotifyLock;
PopNotifyWork;
PopNumberOfPagesForHibernateProcess;
PopNumberOfRegisteredIdleDisks;
PopPendingWakeInfo;
...
_imp_HalDynamicProcessorStarted;
