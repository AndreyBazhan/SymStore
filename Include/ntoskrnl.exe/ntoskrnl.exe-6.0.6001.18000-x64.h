...
typedef struct _ALPC_COMPLETION_PACKET_LOOKASIDE {
    ...
    PVOID CompletionKey;
    struct _ALPC_COMPLETION_PACKET_LOOKASIDE_ENTRY Entry[0];
};
...
typedef struct _KNODE {
    ...
    ULONG64 FreeCount[2];
    struct _SLIST_ENTRY *PfnDeferredList;
    ULONG Right;
    ULONG Left;
...
typedef struct _KTHREAD {
    ...
    UCHAR WaitBlockFill0[43];
    UCHAR IdealProcessor;
    UCHAR WaitBlockFill1[91];
    CHAR PreviousMode;
    UCHAR WaitBlockFill2[139];
    UCHAR ResourceIndex;
    UCHAR WaitBlockFill3[187];
    UCHAR LargeStack;
...
typedef struct _KUSER_SHARED_DATA {
    ...
    ULONG64 AffinityPad;
    ULONG64 ActiveProcessorAffinity;
...
typedef struct _MMWSLENTRY {
    ULONG64 Valid : 1;
    ULONG64 LockedInWs : 1;
    ULONG64 LockedInMemory : 1;
    ULONG64 Protection : 5;
    ULONG64 Hashed : 1;
    ULONG64 Direct : 1;
    ULONG64 Age : 2;
...
typedef struct _POP_POWER_ACTION {
    ...
    ULONG Flags;
    LONG Status;
    enum POP_POLICY_DEVICE_TYPE DeviceType;
    ...
    struct _POP_DISPLAY_RESUME_CONTEXT *DisplayResumeContext;
...
typedef struct _PO_HIBER_PERF {
    ...
    ULONG DumpCount;
    ULONG FileRuns;
    ULONG64 ResumeAppStartTime;
    ULONG64 ResumeAppEndTime;
...
typedef struct _PROCESSOR_POWER_STATE {
    ...
    ULONG64 LastTimeCheck;
    ULONG64 IdleTimeAccumulated;
    struct {
    ...
    ULONG64 LastGlobalTimeHv;
    ULONG64 LastProcessorTimeHv;
...
typedef enum WHEA_PCIEXPRESS_DEVICE_TYPE {
...
CMFSystemViewOwnerThread;
CMFSystemViewTimeStamp;
...
CcDbgNumberOfTriesToFreeVacbArrays;
CcDbgNumberOfVacbArraysAllocated;
CcDbgNumberOfVacbArraysFreed;
...
CmpBackupFlushInProgress;
CmpBackupFlushPending;
CmpBootType;
CmpCacheTable;
...
CmpFailPrimarySave;
CmpFeatureBits;
CmpFirstBackupFlushDone;
CmpFirstBackupFlushDpc;
CmpFirstBackupFlushTimer;
CmpFirstBackupWorkItem;
...
CmpNoWrite;
CmpOpenSubKeys;
CmpPeriodicBackupFlushDpc;
CmpPeriodicBackupFlushHiveCount;
CmpPeriodicBackupFlushTimer;
CmpPeriodicBackupWorkItem;
CmpPostLock;
...
ExpProxyPolicySupportAvailable;
...
IopLiveDumpDiagnosticInformation;
...
IopWarmEjectLock;
IopWarmEjectPdo;
IopWin32DataCollectionProcedureCallout;
IopWstrHal;
IopWstrLoaderReservedMemory;
IopWstrPhysicalMemory;
IopWstrSpecialMemory;
IopWstrSystem;
IovDisabledWithoutReboot;
IovDriverListHead;
IovForcePendingLog;
IovForcedPendingIrps;
IovForcedPendingLogLength;
IovIrpTraces;
IovIrpTracesIndex;
IovIrpTracesLength;
IovUtilVerifierEnabled;
IovpCancelCount;
IovpForcePendingEnabled;
IovpForcePendingIrpFlagsToAvoid;
IovpForcePendingProbability;
IovpInitCalled;
IovpVerifierFlags;
IrpMajorNames;
...
MiInitFailure;
MiInitialLargePage;
MiInitialNonPagedPoolNodeStart;
MiInitialPoolFreed;
...
POP_ETW_EVENT_PRESLEEP_NOTIFICATION;
...
PopLastUserInputOccurred;
PopNotifyEvents;
PopNotifyLock;
PopNotifyWork;
PopNumberOfPagesForHibernateProcess;
PopPendingWakeInfo;
PopPerfCountUnitsPerMS;
PopPolicy;
PopPolicyIrpQueue;
PopPolicyLock;
PopPolicyLockThread;
...
PopPowerTransitionComplete;
PopProcessorSimulatedLoad;
PopRegKey;
...
RtlpCType844;
RtlpCTypeMap;
RtlpDatabaseLockInitGuardDone;
RtlpDatabaseLockInitGuardEnter;
...
VfBugcheckData;
VfBugcheckLock;
VfEnhancedIoDisabledWithoutReboot;
...
ViCancelBreakFlags;
ViCancelDisable;
ViCancelDisabledWithoutReboot;
ViCancelGlobals;
ViCancelInformationLookaside;
ViCancelIrpFlagsToAvoid;
ViCancelIrpsToCancelList;
ViCancelIrpsToCancelWorkItem;
ViCancelIrpsUnderWatchDpc;
ViCancelIrpsUnderWatchList;
ViCancelIrpsUnderWatchTimer;
ViCancelThreshold;
ViCancelTimerPeriod;
ViCancelTrackProbability;
ViCancelTrackingStructuresCount;
ViCancelWatchQueueLengthHighWater;
ViCancelWatchQueueOverheadHighWater;
ViCancelledIrps;
ViCancelledIrpsIndex;
ViCancelledIrpsNotWatched;
ViCodeSectionHandle;
ViCompletionGlobals;
ViCompletionInformationLookaside;
ViCompletionIrpFlagsToAvoid;
ViCompletionThreshold;
...
ViFaultsInitialized;
ViForceCancelEnabled;
ViForceCancelProbability;
ViForcePendingEnabledInThePast;
ViFullyInitialized;
...
ViIrpLogDdiLock;
ViIrpStackSwitchLog;
ViIrpStackSwitchLogIndex;
ViIrpStackSwitchLogLength;
ViIssueLog;
ViIssueLogBreak;
ViIssueLogIndex;
ViIssueLogLock;
...
ViPacketLookaside;
ViPenalties;
ViPoolDelayFreeCalls;
ViPoolDelayFreeInitialized;
ViPoolDelayFreeListLengthWatermark;
ViPoolDelayFreeListTooLong;
ViPoolDelayFreeListTrims;
ViPoolDelayFreeSListHead;
ViPoolDelayFreeTrimEvent;
ViProtectBuffers;
ViRandomExAuxVarY;
...
WdipSemTimeoutValue;
WheapAddedErrorSourceLock;
WheapCorrectedMCECount;
WheapDispatchPtr;
WheapErrorRecordId;
WheapErrorSourceInitializer;
...
WheapTimerDpc;
WheapTimerInterval;
WheapTrackedCorrectedErrorListHead;
...
WmipWmiLibInfo;
WorstCaseFill;
X64_PROCESSOR_SPECIFIC_SECTION_GUID;
XIPConfiguration;
XIPConfigured;
XIPlocate_breakin;
XIPlocate_disable;
...
_setloc_data;
_wnullstring;
`ADD_MAP_REGISTERS'::`3'::StopAction;
`ADD_MAP_REGISTERS'::`6'::StopAction;
`DECREMENT_ADAPTER_CHANNELS'::`3'::StopAction;
`DECREMENT_COMMON_BUFFERS'::`3'::StopAction;
`DECREMENT_SCATTER_GATHER_LISTS'::`3'::StopAction;
`INCREASE_MAPPED_TRANSFER_BYTE_COUNT'::`3'::StopAction;
`INCREMENT_ADAPTER_CHANNELS'::`3'::StopAction;
`SUBTRACT_MAP_REGISTERS'::`3'::StopAction;
`VERIFY_BUFFER_LOCKED'::`3'::StopAction;
`VF_ASSERT_IRQL'::`3'::StopAction;
`VF_ASSERT_MAX_IRQL'::`3'::StopAction;
abWPAStringKey;
curr_x;
curr_y;
errno;
