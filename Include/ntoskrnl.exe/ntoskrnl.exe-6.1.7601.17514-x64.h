...
typedef struct _ALIGNED_AFFINITY_SUMMARY {
    struct _KAFFINITY_EX CpuSet;
    struct _KAFFINITY_EX SMTSet;
};
...
typedef struct _CMHIVE {
    ...
    USHORT MappedViewCount;
    USHORT PinnedViewCount;
    ULONG UseCount;
    ULONG ViewsPerHive;
...
typedef struct _ETW_BUFFER_HANDLE {
    struct _WMI_BUFFER_HEADER *TraceBuffer;
    struct _EX_FAST_REF *BufferFastRef;
};
...
typedef struct _ETW_GUID_ENTRY {
    ...
    struct _EVENT_FILTER_HEADER *FilterData[8];
};
...
typedef struct _ETW_REALTIME_CONSUMER {
    ...
    ULONG LoggerId;
    UCHAR ShutDownRequested;
    UCHAR NewBuffersLost;
    UCHAR Disconnected;
...
typedef struct _IMAGE_SECURITY_CONTEXT {
    PVOID PageHashes;
    ULONG64 Value;
    ULONG64 SecurityBeingCreated : 1;
...
typedef struct _MI_SECTION_CREATION_GATE {
    struct _MI_SECTION_CREATION_GATE *Next;
    struct _KGATE Gate;
};
...
typedef struct _MI_SYSTEM_PTE_TYPE {
    ...
    PULONG FailureCount;
    struct _MMSUPPORT *Vm;
    LONG TotalSystemPtes;
    LONG TotalFreeSystemPtes;
    LONG CachedPteCount;
    ULONG PteFailures;
    ULONG64 SpinLock;
...
typedef struct _MMPFN {
    ...
    union {
        ULONG64 PteFrame : 52;
        ULONG64 Unused : 3;
        ULONG64 PfnImageVerified : 1;
        ULONG64 AweAllocation : 1;
...
typedef struct _MMVAD_FLAGS {
    ULONG64 CommitCharge : 51;
    ULONG64 NoChange : 1;
    ULONG64 VadType : 3;
    ULONG64 MemCommit : 1;
    ULONG64 Protection : 5;
    ULONG64 Spare : 2;
    ULONG64 PrivateMemory : 1;
};
...
typedef struct _MMVAD_FLAGS3 {
    ULONG64 PreferredNode : 6;
    ULONG64 Teb : 1;
    ULONG64 Spare : 1;
    ULONG64 SequentialAccess : 1;
    ULONG64 LastSequentialTrim : 15;
    ULONG64 Spare2 : 8;
    ULONG64 LargePageCreating : 1;
    ULONG64 Spare3 : 31;
};
...
typedef struct _MMWSL {
    ...
    ULONG64 CommittedPageDirectories[128];
...
typedef struct _MMWSLENTRY {
    ...
    ULONG64 Protection : 5;
    ULONG64 Age : 3;
    ULONG64 VirtualPageNumber : 52;
};

typedef struct _MMWSLE_FREE_ENTRY {
    ULONG64 MustBeZero : 1;
    ULONG64 PreviousFree : 31;
    ULONG64 NextFree : 32;
};
...
typedef struct _PNP_DEVICE_COMPLETION_REQUEST {
    ...
    PVOID Information;
    struct _WORK_QUEUE_ITEM WorkItem;
    struct _DRIVER_OBJECT *FailingDriver;
    LONG ReferenceCount;
};
...
typedef struct _POP_HIBER_CONTEXT {
    ...
    ULONG CompressedWriteBufferSize;
    ULONG MaxCompressedOutputSize;
...
typedef struct _POP_POWER_ACTION {
    ...
    ULONG64 WakeTime;
    ULONG64 SleepTime;
    ULONG64 ProgrammedRTCTime;
    UCHAR WakeOnRTC;
    struct _DIAGNOSTIC_BUFFER *WakeTimerInfo;
...
typedef struct _PO_HIBER_PERF {
    ...
    ULONG64 ResumeAppTime;
    ULONG64 HiberFileResumeTime;
    ULONG64 BytesCopied;
...
typedef struct _UMS_CONTROL_BLOCK {
    ...
    ULONG UmsPerformingSingleStep : 1;
    USHORT TebSelector;
};
...
typedef union _KBUGCHECK_ACTIVE_STATE {
    ULONG BugCheckState : 2;
    ULONG RecursionCount : 2;
    ULONG BugCheckOwner : 28;
    LONG Value;
};
...
CmVEEnabled;
CmVersionString;
CmViewsPerHiveDenominator;
CmViewsPerHiveNumerator;
...
CmpBootLoadControl;
CmpBootType;
CmpCacheTrimDirtyHint;
CmpCacheTrimWorkItem;
CmpCacheTrimWorkItemActive;
CmpCallBackCount;
CmpCallbackCookie;
...
CmpInitRmLogOnLoad;
CmpLazyCommitDpc;
CmpLazyCommitIntervalInSeconds;
CmpLazyCommitListHead;
CmpLazyCommitListLock;
CmpLazyCommitTimer;
...
EtwpProfileInterval;
EtwpProfileObject;
EtwpProfileSourceActive;
EtwpProfileSourceRequested;
EtwpProviderTable;
...
ExpBootLicensingBuffer;
ExpBootLicensingData;
ExpBootLicensingDataLength;
ExpBootLicensingDataType;
ExpCacheLineSize;
ExpCacheProviders;
ExpCallBackFlush;
ExpCallbackEvent;
...
ExpLicenseInfo;
ExpLicenseInfoCount;
ExpLicensingCacheAge;
ExpLicensingCacheAgingEnabled;
ExpLicensingCacheAllowedAge;
ExpLicensingCacheCorrupt;
ExpLicensingCacheHeaderFlagsInternal;
ExpLicensingCallback;
ExpLicensingDescriptors;
ExpLicensingDescriptorsCount;
ExpLicensingDescriptorsSorted;
ExpLicensingLock;
ExpLicensingSection;
ExpLicensingTamperState;
ExpLicensingView;
ExpLuid;
ExpLuidIncrement;
...
ExpRefreshFailures;
ExpRegistryAppendStringPushLock;
...
ExpShuttingDown;
ExpSleepStartTickCount;
ExpSleepTotalDuration;
...
ImageLoad;
ImageUnload;
InbvBootDriverFullyInitialized;
...
IoBlanketBoostCount;
IoBoostedInPriorityRegionCount;
...
KNetEvt_TcpCopyIPV4;
KNetEvt_TcpCopyIPV6;
KTM_ETW_EVENT_TRANSACTIONMANAGER_NOT_ADVANCING_TAIL;
KTM_ETW_EVENT_TRANSACTION_BLOCKED_FREEZE;
KTM_ETW_EVENT_TRANSACTION_HEURISTIC_CORRUPTION;
KTM_ETW_EVENT_TRANSACTION_ROLLBACK_LOG_ERROR;
KTM_ETW_EVENT_TRIGGER_SVC_START;
KTM_ETW_PROVIDER;
KTM_ETW_TRIGGER_PROVIDER;
KdAutoEnableOnEvent;
KdBlockEnable;
...
KeTestAddedFeatureMask;
KeTestAddedFeatures;
KeTestDisableXSave;
KeTestProcessorSpecific;
KeTestProcessorsMask;
KeTestRemovedFeature;
...
KiInitialProcess;
KiInitialThread;
KiInterlockedPopEntrySListEndEntryPoint;
KiInterlockedPopEntrySListFaultEntryPoint;
KiInterlockedPopEntrySListResumeEntryPoint;
...
KiOldIrql;
KiOpOneByteTable;
KiOpPrefetchIllegalEncoding;
KiOpPrefetchPatchCount;
KiOpPrefetchPatchRetry;
KiOpPrefixTable;
KiOpTwoByteTable;
KiPendingTimers;
...
KiWaitAlways;
KiWaitNever;
KiXRstorPatchPointers;
KiXSaveOptPatchPointers;
...
MiLowPriorityWsThreshold;
MiMapCacheFailures;
MiMappedFileIoComplete;
...
MiNonPagedPoolVaBitMapHint;
MiNonPagedPoolVaBits;
MiPageFileContract;
...
MiSessionDynamicPoolBitBuffer;
MiSessionDynamicPtesBitBuffer;
MiSessionDynamicVaBitBuffer;
MiSessionDynamicVaStart;
MiSessionIdBitmap;
MiSessionIdMutex;
...
MiSystemTablesLock;
MiSystemVaBitMap;
MiSystemVaBitMapHint;
MiSystemVaBits;
MiSystemVaLock;
MiSystemVaTypeCount;
MiSystemVmTypes;
MiSystemWorkingSetsBase;
MiTempEvent;
MiTotalPagesAllowed;
MiTotalUnloads;
MiTrackIoLock;
...
MiTrimPassToAge;
MiTrimStamp;
MiTrimWhileAgingHighThreshold;
MiTrimWhileAgingLowThreshold;
MiTruncateFailures;
MiUnloadsSkipped;
MiUnusableSystemWsles;
MiUnusedSubsectionPagedPool;
MiVerifierStopRecursion;
...
MmTotalProcessPagesForPagingFile;
...
PnpBusTypeGuidLock;
PnpCurrentControlSetControlClassHandle;
PnpCurrentControlSetEnumHandle;
PnpCurrentControlSetHandle;
PnpCurrentControlSetServicesHandle;
...
PopThermal;
PopThermalLock;
PopThermalZoneMetricsSqmPeriod;
PopTransitionLock;
PopUmpoAlpcClientConnected;
PopUmpoAlpcInitialized;
...
PpmParkNodes;
PpmParkNumNodes;
PpmPerfControlCommit;
PpmPerfControlInitiate;
...
PspDisableExceptionChainValidation;
PspFixedQuantums;
PspForegroundQuantum;
PspGlobalFlags;
PspHandleSweepCacheWorkItem;
PspHandleSweepNeededCount;
PspHandleSweepNeededCountCache;
PspHandleSweepProcessCache;
PspHandleSweepWorkItem;
...
TmpAllCRMListMutex;
TmpAllPropReqsList;
TmpAllPropReqsListMutex;
TmpAllProtocolsList;
TmpAllProtocolsListCount;
TmpAllProtocolsListMutex;
TmpAllProtocolsStaticInfoLength;
TmpCheckForProgressDpc;
TmpCheckForProgressTimer;
TmpCheckForProgressWorkItem;
TmpEnlistmentMapping;
TmpEtwHandle;
TmpFreezeMutex;
TmpKtmRmDescriptor;
TmpKtmRmServiceStartGuid;
TmpKtmRmTmGuid;
TmpLogPrefix;
TmpLogWriteLookasideList;
TmpOleTxProtocolId;
TmpPromotingProtocolId;
TmpPromotingProtocolRegistered;
TmpResourceManagerMapping;
TmpShutdownOccurred;
TmpTmAdvanceTailWarningInterval;
TmpTmNamespace;
TmpTransactionFreezeCancelEvent;
TmpTransactionFreezeCompleteEvent;
TmpTransactionManagerMapping;
TmpTransactionMapping;
TmpTransactionThawDpc;
TmpTransactionThawEvent;
TmpTransactionThawTimer;
TmpTransactionThawWorkItem;
TmpTransactionTypeName;
TmpTransactionsCommittedActive;
TmpTransactionsFreezeCancelled;
TmpTransactionsFrozen;
TmpTransactionsNamespace;
TmpTriggerHandle;
TotalTraceBuffers;
TraceDataBuffer;
TraceDataSyms;
...
ViCtxAllocatedContexts;
ViCtxContextSize;
ViCtxHintIndex;
ViCtxInterrupts;
ViCtxInterruptsChecked;
ViCtxXSaveContexts;
ViCtxXSaveEnabledMask;
...
_clocalestr;
_fastflag;
_imp_CLFS_LSN_INVALID;
_imp_CLFS_LSN_NULL;
_imp_CiInitialize;
_imp_ClfsAddLogContainer;
_imp_ClfsAdvanceLogBase;
...
_imp_ClfsMgmtHandleLogFileFull;
_imp_ClfsMgmtInstallPolicy;
_imp_ClfsMgmtRegisterManagedClient;
_imp_ClfsMgmtSetLogFileSize;
_imp_ClfsMgmtTailAdvanceFailure;
_imp_ClfsPrivGetBaseLogFileFromFileObjectPointer;
_imp_ClfsReadLogRecord;
_imp_ClfsReadNextLogRecord;
_imp_ClfsReadRestartArea;
_imp_ClfsReserveAndAppendLog;
_imp_ClfsReserveAndAppendLogAligned;
...
_imp_HalSetProfileInterval;
_imp_HalSetRealTimeClock;
_imp_HalSetTimeIncrement;
...
_imp_KdD0Transition;
_imp_KdD3Transition;
_imp_KdDebuggerInitialize0;
_imp_KdDebuggerInitialize1;
...
_imp_NtClose;
_imp_NtEnumerateKey;
_imp_NtEnumerateValueKey;
_imp_NtOpenKey;
_imp_NtOpenSymbolicLinkObject;
_imp_NtQuerySymbolicLinkObject;
...
_imp_RtlEthernetAddressToStringW;
_imp_RtlInitUnicodeString;
_imp_RtlIntegerToUnicodeString;
_imp_RtlIpv4AddressToStringW;
_imp_RtlIpv6AddressToStringW;
_imp_RtlLengthSid;
_imp_RtlValidSid;
...
_setloc_data;
_wnullstring;
`ADD_MAP_REGISTERS'::`4'::StopAction;
`ADD_MAP_REGISTERS'::`6'::StopAction;
`DECREMENT_ADAPTER_CHANNELS'::`4'::StopAction;
`DECREMENT_COMMON_BUFFERS'::`4'::StopAction;
`DECREMENT_SCATTER_GATHER_LISTS'::`4'::StopAction;
`INCREASE_MAPPED_TRANSFER_BYTE_COUNT'::`4'::StopAction;
`INCREMENT_ADAPTER_CHANNELS'::`4'::StopAction;
...
`SUBTRACT_MAP_REGISTERS'::`4'::StopAction;
`VERIFY_BUFFER_LOCKED'::`4'::StopAction;
`VF_ASSERT_IRQL'::`4'::StopAction;
`VF_ASSERT_MAX_IRQL'::`4'::StopAction;
abWPAStringKey;
curr_x;
curr_y;
errno;
...
g_BufferedWorkItemCount;
g_BufferedWorkItems;
g_CacheLock;
g_CiCallbacks;
g_CiEnabled;
g_DeferredWorkItemLock;
g_EtwHandle;
g_ForwardQueue;
g_ServiceConnectFailures;
g_ServiceLock;
g_ServiceTimeoutDpc;
g_ServiceTimeoutFlushGate;
g_ServiceTimeoutFlushWorkItem;
g_ServiceTimeoutTimer;
g_ShimCache;
g_Stats;
g_bCacheEnabled;
g_bServiceRunning;
...
ApphelpCacheDeleteApphelpData();
ApphelpCacheDeleteEntry();
...
ApphelpCacheForward();
ApphelpCacheFreeCustomData();
ApphelpCacheFreeEntry();
...
BCryptSetProperty();
B_TREE<_SM_PAGE_KEY,SMKM_STORE_MGR<SM_TRAITS>::SMKM_FRONTEND_ENTRY,4096,B_TREE_DUMMY_NODE_POOL>::BTreeCleanup();
B_TREE<_SM_PAGE_KEY,SMKM_STORE_MGR<SM_TRAITS>::SMKM_FRONTEND_ENTRY,4096,B_TREE_DUMMY_NODE_POOL>::BTreeDeleteEx();
B_TREE<_SM_PAGE_KEY,SMKM_STORE_MGR<SM_TRAITS>::SMKM_FRONTEND_ENTRY,4096,B_TREE_DUMMY_NODE_POOL>::BTreeDeleteNode();
...
B_TREE<_SM_PAGE_KEY,SMKM_STORE_MGR<SM_TRAITS>::SMKM_FRONTEND_ENTRY,4096,B_TREE_DUMMY_NODE_POOL>::BTreeIteratorAttachEx();
...
B_TREE<_SM_PAGE_KEY,SMKM_STORE_MGR<SM_TRAITS>::SMKM_FRONTEND_ENTRY,4096,B_TREE_DUMMY_NODE_POOL>::BTreeSearchResultInit();
...
B_TREE<_SM_PAGE_KEY,ST_STORE<SM_TRAITS>::_ST_PAGE_ENTRY,4096,NP_CONTEXT>::BTreeCleanup();
...
B_TREE<_SM_PAGE_KEY,ST_STORE<SM_TRAITS>::_ST_PAGE_ENTRY,4096,NP_CONTEXT>::BTreeInsert();
...
B_TREE<_SM_PAGE_KEY,ST_STORE<SM_TRAITS>::_ST_PAGE_ENTRY,4096,NP_CONTEXT>::BTreeSearchResultCleanup();
...
B_TREE<_SM_PAGE_KEY,ST_STORE<SM_TRAITS>::_ST_PAGE_ENTRY,4096,NP_CONTEXT>::BTreeSearchResultInitEx();
B_TREE<_SM_PAGE_KEY,ST_STORE<SM_TRAITS>::_ST_PAGE_ENTRY,4096,NP_CONTEXT>::BTreeSplitChild();
B_TREE<_SM_PAGE_KEY,ST_STORE<SM_TRAITS>::_ST_PAGE_ENTRY,4096,NP_CONTEXT>::BTreeWalkPostOrder();
B_TREE<_SM_PAGE_KEY,ST_STORE<SM_TRAITS>::_ST_PAGE_ENTRY,4096,NP_CONTEXT>::BTreeWalkPostOrderEx();
B_TREE<unsigned long,ST_STORE<SM_TRAITS>::_ST_REGION_ENTRY,4096,NP_CONTEXT>::BTreeChangeKey();
B_TREE<unsigned long,ST_STORE<SM_TRAITS>::_ST_REGION_ENTRY,4096,NP_CONTEXT>::BTreeCleanup();
...
B_TREE<unsigned long,ST_STORE<SM_TRAITS>::_ST_REGION_ENTRY,4096,NP_CONTEXT>::BTreeSearchResultCleanup();
...
B_TREE<unsigned long,ST_STORE<SM_TRAITS>::_ST_REGION_ENTRY,4096,NP_CONTEXT>::BTreeSearchResultInitEx();
B_TREE<unsigned long,ST_STORE<SM_TRAITS>::_ST_REGION_ENTRY,4096,NP_CONTEXT>::BTreeSplitChild();
B_TREE<unsigned long,ST_STORE<SM_TRAITS>::_ST_REGION_ENTRY,4096,NP_CONTEXT>::BTreeWalkPostOrder();
B_TREE<unsigned long,ST_STORE<SM_TRAITS>::_ST_REGION_ENTRY,4096,NP_CONTEXT>::BTreeWalkPostOrderEx();
...
NP_CONTEXT::NpLeafAdd();
NP_CONTEXT::NpLeafDeref();
NP_CONTEXT::NpLeafRef();
NP_CONTEXT::NpLeafRemove();
...
SMKM_STORE<SM_TRAITS>::SmStEtaCheckForRefresh();
...
SMKM_STORE<SM_TRAITS>::SmStMapRegion();
SMKM_STORE<SM_TRAITS>::SmStReleaseRegion();
SMKM_STORE<SM_TRAITS>::SmStStart();
SMKM_STORE<SM_TRAITS>::SmStStatsUpdate();
SMKM_STORE<SM_TRAITS>::SmStUnmapRegion();
SMKM_STORE<SM_TRAITS>::SmStWorkItemDefer();
...
SMKM_STORE_MGR<SM_TRAITS>::SmIoCtxInitialize();
...
SMKM_STORE_MGR<SM_TRAITS>::SmStart();
...
SMKM_STORE_MGR<SM_TRAITS>::SmWorkItemTimeout();
...
ST_STORE<SM_TRAITS>::StDmPerformTrim();
