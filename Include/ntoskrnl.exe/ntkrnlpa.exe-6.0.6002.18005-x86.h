...
typedef struct _POP_HIBER_CONTEXT {
    ...
    struct _PO_MEMORY_RANGE_TABLE *TableHead;
...
REG_EVENT_SELFHEAL;
REG_EVENT_TXR_INIT_CLFS_LOG_OPEN_FAIL;
RamdiskBootDiskGuid;
...
AlpcpReceiveView();
AlpcpReferenceAndLockTargetPorts();
...
AlpcpReleaseAttributesOnCancel();
