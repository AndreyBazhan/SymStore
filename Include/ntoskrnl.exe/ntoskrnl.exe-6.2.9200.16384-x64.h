...
typedef struct _CMHIVE {
    ...
    ULONG FlushActive : 1;
    ULONG DiskFileBad : 1;
    ULONG FlushBoosted : 1;
    ULONG PrimaryWritePending : 1;
    ULONG PriorPurgeComplete : 1;
...
typedef struct _CONTROL_AREA {
    ...
    union {
        struct {
            ...
            ULONG BitMap : 2;
            ULONG ImageActive : 1;
            struct _MM_AVL_TABLE *SubsectionRoot;
...
typedef struct _ETW_GUID_ENTRY {
    ...
    struct _EVENT_FILTER_HEADER **FilterData;
};
...
typedef struct _MM_SESSION_SPACE {
    ...
    struct _FAST_MUTEX SessionVaLock;
...
typedef union _MMVIEW_CONTROL_AREA {
    struct _CONTROL_AREA *ControlArea;
    ULONG64 Writable : 1;
    ULONG64 ExceptionForInPageErrors : 1;
    ULONG64 Unused : 1;
    ULONG64 UsedForControlArea : 61;
};
...
CcCoalescingDirtyThresholdPages;
...
CmpLazyFlushDpc;
CmpLazyFlushEvent;
CmpLazyFlushHoldTime;
CmpLazyFlushIntervalInSeconds;
CmpLazyFlushStartTime;
CmpLazyFlushStatus;
CmpLazyFlushTimer;
CmpListString;
CmpLoadHiveLock;
...
DEVPKEY_Device_PendingConfigurationId;
...
DEVPKEY_DriverDatabase_Mounted;
...
ExpSemaphoreMapping;
ExpSessionMachineIdentifierBuffer;
...
ExpWnfAlwaysDispatchAsyncronously;
ExpWnfDispatcher;
ExpWnfInjectedThreadTimeout;
...
ExpWorkerPriorityMismatchMessage;
...
GlobalSaclKeyPrefix;
GuidFormat;
HV_EVENTLOG_BAL_CPUID_MIN_LEAVES_NOT_SUPPORTED;
HV_EVENTLOG_BAL_CPUID_PHY_ADDR_LIMIT_EXCEEDED;
HV_EVENTLOG_BAL_FIRMWARE_INFO_INVALID;
HV_EVENTLOG_BAL_FIRMWARE_TABLE_NOT_FOUND;
HV_EVENTLOG_BAL_HW_INCOMPAT_SVM_COMPAT;
HV_EVENTLOG_BAL_HW_INCOMPAT_VMX_COMPAT;
HV_EVENTLOG_BAL_HYPERVISOR_INIT_FAILED;
HV_EVENTLOG_BAL_HYPERVISOR_VERSION_MISMATCH;
HV_EVENTLOG_BAL_INSUFFICIENT_CAPABILITY_SUPPORT;
HV_EVENTLOG_BAL_INTERNAL_LOGIC_ERROR;
HV_EVENTLOG_BAL_INVALID_HYPERVISOR_IMAGE;
HV_EVENTLOG_BAL_NO_EXECUTE_NOT_DETECTED;
HV_EVENTLOG_BAL_PLATFORM_MISMATCH;
HV_EVENTLOG_BAL_REQUIRED_HARDWARE_FEATURES_NOT_PRESENT;
HV_EVENTLOG_BAL_REQUIRED_HARDWARE_FEATURE_NOT_SUPPORTED;
HV_EVENTLOG_BAL_SLAT_NOT_PRESENT;
HV_EVENTLOG_BAL_SMX_ENABLED;
HV_EVENTLOG_BAL_SVM_NOT_DETECTED;
HV_EVENTLOG_BAL_UNSUPPORTED_PLATFORM;
HV_EVENTLOG_BAL_VMX_NOT_DETECTED;
HV_EVENTLOG_BAL_WINLOAD_CONFLICTING_ADDRESSES;
HV_EVENTLOG_BAL_WINLOAD_INSUFFICIENT_RESOURCES;
HV_EVENTLOG_BAL_WINLOAD_NO_MEMORY;
HV_EVENTLOG_BAL_WINLOAD_PERSISTENT_MEMORY_FAILURE;
HV_EVENTLOG_BAL_WINLOAD_RESOURCE_NOT_FOUND;
HV_EVENTLOG_BAL_WINLOAD_UNSUCCESSFUL;
...
MiImageBitMap64Low;
MiImageBitmapBuffer;
MiImageBitmapBuffer64High;
MiImageBitmapBuffer64Low;
MiImageFailure;
...
PopAction;
PopActionWaiters;
PopAdaptiveDisplayTimeout;
PopAdaptiveInputTimeout;
...
PopDynamicTickDisabled;
PopEffectiveUserPresence;
...
PopNoMoreInput;
PopNonAdaptiveDisplayTimeout;
PopNonAdaptiveInputTimeout;
...
PpmLowPowerScenarioLock;
PpmLpDefaultSettingRoot;
PpmLpScenarioSettingsRegistered;
PpmLpScenarios;
PpmLpScratchSettings;
PpmLpSettings;
PpmLpVersionSubKeyName;
...
_fastflag;
_imp_AppContainerPrivilegesEnabledExt;
_imp_CiInitialize;
...
g_bOverrideAlways;
g_bmType;
g_cbTestHookPolicyName;
g_pbTestHookPolicyName;
g_rgAttributeTags;
g_rgDirectoryTags;
g_strPolicyName;
g_szGuidFormat;
...
CmEtwRunDown();
CmFreezeRegistry();
CmGetAdminAccessSecurityDescriptor();
CmGetBoundTransaction();
CmGetCallbackVersion();
CmGetCommonClassRegKeyPath();
CmGetContainerBooleanProperty();
CmGetContainerBooleanPropertyCallback();
CmGetContainerIsConnectedProperty();
CmGetContainerIsConnectedPropertyCallback();
CmGetContainerIsRebootRequiredCallback();
CmGetDeviceChildren();
...
CmLogMcUpdateStatus();
CmLogTmRmAction();
CmMapCmObjectTypeToPnpObjectType();
CmMapPnpObjectTypeToCmObjectType();
...
CmSetDeviceContainerMappedProperty();
...
EnlightenedSwapContext_PatchLdMxCsr();
EnlightenedSwapContext_PatchStMxCsr();
...
PnpContainerRaiseDevicesChangedEvent();
...
PnpIsIndirectInfString();
PnpIsIndirectResourceString();
PnpIsLegacyDriver();
PnpIsNullGuid();
PnpIsNullGuidString();
PnpIsRangeWithin();
...
StringListContains();
SwapContext();
SwapContext_PatchLdMxCsr();
SwapContext_PatchStMxCsr();
