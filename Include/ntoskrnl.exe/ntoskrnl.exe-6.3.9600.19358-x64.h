...
typedef struct _KPROCESSOR_DESCRIPTOR_AREA {
    union _KIDTENTRY64 Idt[256];
    struct _KTSS64 Tss;
    ULONG64 TssSpare;
    struct _KPCR *KernelGsBase;
    PVOID IdleStack;
    UCHAR TssPad[3968];
    union _KGDTENTRY64 Gdt[8];
    UCHAR GdtEndPadding[3968];
    struct _KTRANSITION_STACK TransitionStack[8];
};
...
typedef struct _KTRANSITION_STACK {
    UCHAR Stack[512];
    UCHAR IstStack[480];
    struct _KIST_BASE_FRAME IstFrame;
};
...
typedef struct _MMWSL {
    ULONG64 FirstFree;
    ULONG64 FirstDynamic;
    ULONG64 LastEntry;
    ULONG64 NextSlot;
    ULONG64 LastInitializedWsle;
    ULONG64 NextAgingSlot;
    ULONG64 NextAccessClearingSlot;
    ULONG LastAccessClearingRemainder;
    ULONG LastAgingRemainder;
    ULONG WsleSize;
    ULONG64 NonDirectCount;
...
typedef struct _MMWSLENTRY {
    ...
    ULONG64 Protection : 5;
    ULONG64 Age : 3;
    ULONG64 VirtualPageNumber : 36;
    ULONG64 HighActiveFlink : 4;
    ULONG64 HighActiveBlink : 4;
    ULONG64 Unused : 8;
};

typedef struct _MMWSLE_FREE_ENTRY {
    ULONG64 MustBeZero : 1;
    ULONG64 PreviousFree : 27;
    ULONG64 NextFree : 36;
};
...
MiCfgBitMapControlArea64;
MiCfgBitMapSection32;
MiCfgBitMapSection64;
...
MiDummyPage;
MiDummyPagePfn;
MiDynamicBitMapDriverImages;
MiDynamicBitMapPagedPool;
MiDynamicBitMapSpecialPool;
MiDynamicBitMapSystemCache;
MiDynamicBitMapSystemPtes;
MiDynamicMemoryLock;
MiFaultWrite;
MiFirstDecayPage;
...
MiSessionDynamicVaBitBufferPages;
...
_IMPORT_DESCRIPTOR_ext-ms-win-ntos-pico-l1-1-0;
...
_imp_PicoDispatchException;
_imp_PicoInit;
_imp_PicoProcessExit;
_imp_PicoSystemCallDispatch;
_imp_PicoThreadExit;
...
ext-ms-win-ntos-pico-l1-1-0_NULL_THUNK_DATA;
...
EnlightenedSwapContext_PatchLdt();
EnlightenedSwapContext_PatchLdtBypass();
...
MI_CLEAR_RESET_PTE();
MI_DECREMENT_SYSTEM_CACHE_VIEW_COUNT();
...
MI_GET_SYSTEM_CACHE_REVERSE_MAP();
...
MI_SET_SYSTEM_CACHE_REVERSE_MAP();
...
MI_WSLE_HASH_VA();
MI_ZERO_SYSTEM_CACHE_VIEW_COUNT();
MUIBugCheck();
...
ST_STORE<SM_TRAITS>::StDmLazyRemoveStatePrepare();
...
SwapContext_PatchLdt();
SwapContext_PatchLdtBypass();
