...
typedef struct _HEAP_SEGMENT {
    ...
    ULONG Flags;
    struct _HEAP *Heap;
    ULONG64 LargestUnCommittedRange;
    PVOID BaseAddress;
    ULONG NumberOfPages;
...
typedef struct _MI_VERIFIER_DRIVER_ENTRY {
    ...
    ULONG Flags;
    ULONG64 Signature;
    struct _SLIST_HEADER PoolPageHeaders;
    struct _SLIST_HEADER PoolTrackers;
...
typedef struct _MMPFN {
    ...
    union {
        ULONG64 EntireFrame;
        ULONG64 PteFrame : 57;
        ULONG64 InPageError : 1;
        ULONG64 VerifierAllocation : 1;
        ULONG64 AweAllocation : 1;
        ULONG64 Priority : 3;
        ULONG64 MustBeCached : 1;
    } u4;
};
...
typedef struct _MM_SESSION_SPACE {
    ...
    struct _MMPTE *SpecialPoolFirstPte;
    struct _MMPTE *SpecialPoolLastPte;
    struct _MMPTE *NextPdeForSpecialPoolExpansion;
    struct _MMPTE *LastPdeForSpecialPoolExpansion;
...
typedef struct _TEB {
    ...
    ULONG64 SparePointer1;
    ULONG64 SoftPatchPtr1;
    ULONG64 SoftPatchPtr2;
...
typedef struct _WMI_LOGGER_CONTEXT {
    ...
    struct _SLIST_HEADER FreeList;
    struct _SLIST_HEADER FlushList;
    struct _SLIST_HEADER WaitList;
    struct _SLIST_HEADER GlobalList;
...
MiSpecialPoolLastPdeForSpecialPoolExpansion;
MiSpecialPoolLastPte;
MiSpecialPoolNextPdeForSpecialPoolExpansion;
...
WmipMSMCAEvent_MemoryPageRemoved;
...
_imp_HalDisableSystemInterrupt;
_imp_HalEnableSystemInterrupt;
