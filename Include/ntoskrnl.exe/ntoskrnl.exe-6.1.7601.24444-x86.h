...
typedef struct _KPRCB {
    ...
    ULONG PrcbShadowMappedPagePad1[335];
    ...
    ULONG DbgLogs[512];
    ULONG DbgCount;
    ULONG PrcbShadowMappedPagePad2[501];
};
...
typedef struct _KUSER_SHARED_DATA {
    ...
    ULONG DEPRECATED_Wow64SharedInformation[16];
    ...
    ULONG AppCompatFlag;
    ULONG64 DEPRECATED_SystemDllNativeRelocation;
    ULONG DEPRECATED_SystemDllWowRelocation;
    ULONG XStatePad[1];
...
typedef struct _MI_PAGEFILE_TRACES {
    ...
    ULONG ModifiedPagesTotal;
    ULONG ModifiedPagefilePages;
...
typedef struct _VIRTUAL_EFI_RUNTIME_SERVICES {
    ...
    ULONG ResetSystem;
    ULONG UpdateCapsule;
    ULONG QueryCapsuleCapabilities;
    ULONG QueryVariableInfo;
};
...
CmpNoMoreTx;
CmpNoWrite;
CmpNormalGroupAttributes;
CmpOpenSubKeys;
CmpOsVisibleWorkaroundStatus;
CmpParseCacheLock;
CmpParseCacheTable;
...
PspApiSetSize;
PspBootAccessToken;
PspBreakOnFailedProtectedProcessOpen;
PspCidTable;
PspCpuQuotaControl;
PspCpuQuotaKeyNames;
...
_imp_KeTryToAcquireQueuedSpinLockRaiseToSynch;
_imp_KfAcquireSpinLock;
_imp_KfLowerIrql;
_imp_KfRaiseIrql;
_imp_KfReleaseSpinLock;
_imp__CLFS_LSN_INVALID;
_imp__CLFS_LSN_NULL;
_imp__CiInitialize;
_imp__ClfsAddLogContainer;
_imp__ClfsAdvanceLogBase;
...
_imp__KeEnterCriticalRegion;
_imp__KeFlushWriteBuffer;
_imp__KeGetCurrentIrql;
_imp__KeLeaveCriticalRegion;
_imp__KeLowerIrql;
...
_imp__NtClose;
_imp__NtEnumerateKey;
_imp__NtEnumerateValueKey;
_imp__NtOpenKey;
_imp__NtOpenSymbolicLinkObject;
_imp__NtQuerySymbolicLinkObject;
...
AlpcpValidateAndPopulateHeader();
...
B_TREE<_SM_PAGE_KEY,SMKM_STORE_MGR<SM_TRAITS>::SMKM_FRONTEND_ENTRY,4096,B_TREE_DUMMY_NODE_POOL>::BTreeIteratorAttach();
...
EnlightenedSwapContext_PatchFxb();
EnlightenedSwapContext_PatchFxe();
EnlightenedSwapContext_PatchXSave();
EnlightenedSwapContext_XRstorBegin();
EnlightenedSwapContext_XRstorEnd();
...
FsRtlpRegisterProviderWithMUPEx2();
FsRtlpRegisterUncProvider();
FsRtlpRegisterUncProviderEx2();
...
IopEnumerateRegisteredFiltersList();
...
IopRegisterFsRegistrationChangeMountAware();
IopRegistryCallback();
...
KiAcquireProcessLockAtDpcLevel();
...
KiStackExpansionExceptionHandler();
KiStartDpcThread();
...
MI_FREE_NON_PAGED_POOL_PAGES_LEFT();
...
MmGetSessionPoolBigPageTracking();
...
StringCchPrintfW();
SwapContext();
SwapContext_PatchFxb();
SwapContext_PatchFxe();
SwapContext_PatchXSave();
SwapContext_XRstorBegin();
SwapContext_XRstorEnd();
SwapSplayLinks();
...
VerifierKeAcquireSpinLockNoReboot();
