...
typedef struct _ADAPTER_OBJECT {
    ...
    ULONG64 LowMemoryLogicalAddressQueueLock;
...
typedef struct _HALP_DMA_DOMAIN_OBJECT {
    ...
    ULONG64 CommonBufferTreeLock;
    struct _LIST_ENTRY VectorCommonBufferListHead;
    ULONG64 VectorCommonBufferLock;
...
IommupHvGpaAlwaysValid;
IommupHvMaximumAsids;
IommupHvPageRequestQueueCount;
IommupHvPageRequestQueues;
IommupHvSvmEnabled;
...
_imp_IoGetDeviceAttachmentBaseRef;
...
_imp_KeAllocateProcessorProfileStructures;
...
_imp_KeDynamicPartitioningSupported;
...
_imp_KeSetEvent;
_imp_KeSetLastBranchRecordInUse;
...
_imp_RtlUdiv128;
_imp_RtlUnsignedMultiplyHigh;
_imp_WheaAttemptClearPoison;
...
RtlStringCchCopyA();
RtlULongLongMult();
TlgDefineProvider_annotation__TlgHalTraceLoggingProviderProv();
TlgEnableCallback();
TlgKeywordOn();
TlgWrite();
