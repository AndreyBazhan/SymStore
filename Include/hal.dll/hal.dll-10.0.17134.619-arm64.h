...
typedef struct _HAL_ARM_ENLIGHTENMENT_INFORMATION {
    ...
    PLONG ConfigureDeviceDomain;
    PLONG FlushDeviceDomain;
    PLONG FlushDeviceDomainVaList;
...
ArmProfileSourceDescriptorCount;
ArmProfileSourceDescriptorListHead;
ArmProfileSourceDescriptorListLock;
...
HalpPmuHandle;
HalpPmuInUse;
HalpPowerPsciContext;
HalpPowerPsciIsQc8994;
HalpPowerPsciLibInitialized;
...
PmRegisters;
PsciFunctionCodes;
PsciPlatformInfoVersionUnknown;
PsciPlatformInfo_v0_2;
PsciPlatformInfo_v0_2_Qc8994;
PsciPlatformInfo_v1_0;
PsciPlatformInfo_v1_1;
SdeiCurrentConduit;
SdeiFunctionCodes;
...
HalpProcessorDetermineHaltPath();
HalpProcessorFreeze();
HalpProcessorHalt();
HalpProcessorHaltEntry();
HalpProcessorHaltExit();
HalpProcessorHaltHvCpuSuspend();
