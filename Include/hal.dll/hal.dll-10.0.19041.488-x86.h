...
typedef struct _ADAPTER_OBJECT {
    ...
    struct _EX_PUSH_LOCK ExpiredLock;
    ...
    ULONG64 LowMemoryLogicalAddressBase;
    ULONG LowMemoryLogicalAddressQueueLock;
    struct _LIST_ENTRY LowMemoryLogicalAddressQueue;
    UCHAR LowMemoryLogicalAddressQueueInUse;
...
typedef struct _DMA_COMMON_BUFFER_VECTOR {
    struct _LIST_ENTRY ListEntry;
    ULONG64 SizeOfEntries;
    ULONG NumberOfEntries;
    struct _HALP_DMA_DOMAIN_OBJECT *Domain;
    struct _MDL *Mdl;
    PVOID BaseAddress;
    ULONG64 BaseLogicalAddress;
...
typedef struct _DMA_OPERATIONS {
    ...
    PLONG AllocateCommonBufferVector;
    PVOID GetCommonBufferFromVectorByIndex;
    PVOID FreeCommonBufferFromVector;
    PVOID FreeCommonBufferVector;
};
...
typedef struct _HALP_DMA_DOMAIN_OBJECT {
    ...
    ULONG CommonBufferTreeLock;
    struct _LIST_ENTRY VectorCommonBufferListHead;
    ULONG VectorCommonBufferLock;
    ULONG DomainRefCount;
};
...
typedef struct _HALP_DMA_TRANSLATION_ENTRY {
    ...
    UCHAR LogicalBounceBufferPremapped;
};
...
typedef struct _INTERRUPT_FUNCTION_TABLE {
    ...
    PVOID DirectedEndOfInterrupt;
    PLONG QueryLocalUnitInfo;
};
...
Amd64ProfileSourceDescriptorListLock;
...
_IMPORT_DESCRIPTOR_ext-ms-win-ntos-ksr-l1-1-3;
...
_imp__IoGetDeviceAttachmentBaseRef;
...
_imp__KeAllocateProcessorProfileStructures;
...
_imp__KeConnectInterruptForHal;
_imp__KeCopyAffinityEx;
_imp__KeCountSetBitsGroupAffinity;
_imp__KeDispatchSecondaryInterrupt;
_imp__KeDynamicPartitioningSupported;
...
_imp__KeInvalidateRangeAllCachesNoIpi;
_imp__KeIpiGenericCall;
_imp__KeIsEmptyAffinityEx;
_imp__KeLoadMTRR;
_imp__KeOrAffinityEx;
...
_imp__KeQueryDpcWatchdogInformation;
...
_imp__KiMcaExceptionHandlerWrapper;
_imp__KsrGetFirmwareInformation;
_imp__MmAllocateContiguousMemorySpecifyCacheNode;
_imp__MmAllocateContiguousNodeMemory;
_imp__MmAllocateMappingAddress;
_imp__MmAllocateNodePagesForMdlEx;
_imp__MmAllocatePagesForMdl;
_imp__MmAllocatePagesForMdlEx;
_imp__MmBuildMdlForNonPagedPool;
_imp__MmFreeContiguousMemory;
_imp__MmFreeContiguousMemorySpecifyCache;
...
_imp__RtlRbInsertNodeEx;
_imp__RtlRbRemoveNode;
_imp__RtlSetAllBits;
_imp__RtlSetBit;
_imp__RtlSetBits;
_imp__RtlTestBit;
...
ext-ms-win-ntos-ksr-l1-1-3_NULL_THUNK_DATA;
...
DmrpRmrrTreeDoesRegionAlreadyExist();
DmrpRmrrTreeFindScope();
...
HalpDmaBuildKnownResourceIdString();
...
HalpMcaReadErrorCorrectedIntel();
